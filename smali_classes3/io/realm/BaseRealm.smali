...
.method constructor <init>(Lio/realm/RealmConfiguration;Lio/realm/internal/OsSchemaInfo;Lio/realm/internal/OsSharedRealm$VersionID;)V
    ...
    const-string/jumbo v4, ".realm.temp"
...
.method protected static migrateRealm(Lio/realm/RealmConfiguration;Lio/realm/RealmMigration;)V
    ...
    .line 24
    .line 25
    const-string/jumbo v0, "RealmMigration must be provided."
    ...
    .line 58
    .line 59
    const-string/jumbo v1, "Cannot migrate a Realm file which doesn\'t exist: "
    ...
    .line 80
    .line 81
    const-string/jumbo p1, "Manual migrations are not supported for synced Realms"
    ...
    .line 88
    .line 89
    const-string/jumbo p1, "RealmConfiguration must be provided"
...
.method protected addListener(Lio/realm/RealmChangeListener;)V
    ...
    .line 29
    .line 30
    const-string/jumbo v0, "It is not possible to add a change listener to a frozen Realm since it never changes."
...
.method public abstract asFlowable()Lio/reactivex/f;
.end method
...
.method protected checkAllowQueriesOnUiThread()V
    ...
    .line 26
    .line 27
    const-string/jumbo v1, "Queries on the UI thread have been disabled. They can be enabled by setting \'RealmConfiguration.Builder.allowQueriesOnUiThread(true)\'."
...
.method protected checkAllowWritesOnUiThread()V
    ...
    .line 26
    .line 27
    const-string/jumbo v1, "Running transactions on the UI thread has been disabled. It can be enabled by setting \'RealmConfiguration.Builder.allowWritesOnUiThread(true)\'."
...
.method checkNotInSync()V
    ...
    .line 12
    .line 13
    const-string/jumbo v1, "You cannot perform destructive changes to a schema of a synced Realm"
...
.method protected finalize()V
    ...
    .line 27
    .line 28
    const-string/jumbo v1, "Remember to call close() on all Realm instances. Realm %s is being finalized without being closed, this can lead to running out of native memory."
...
.method getEmbeddedObjectRow(Ljava/lang/String;Lio/realm/internal/RealmObjectProxy;Ljava/lang/String;Lio/realm/RealmSchema;Lio/realm/RealmObjectSchema;)Lio/realm/internal/Row;
    ...
    .line 71
    .line 72
    const-string/jumbo p1, "Parent type %s expects that property \'%s\' be of type %s but was %s."
    ...
    .line 87
    .line 88
    const-string/jumbo p3, "Field \'%s\' does not contain a valid link"
...
.method public refresh()V
    ...
    .line 21
    .line 22
    const-string/jumbo v1, "Cannot refresh a Realm instance inside a transaction."
...
.method protected removeAllListeners()V
    ...
    .line 19
    .line 20
    const-string/jumbo v1, "Calling removeChangeListener on a closed Realm %s, make sure to close all listeners before closing the Realm."
...
.method public waitForChange()Z
    ...
    .line 32
    .line 33
    const-string/jumbo v1, "Cannot wait for changes inside a Looper thread. Use RealmChangeListeners instead."
    ...
    .line 40
    .line 41
    const-string/jumbo v1, "Cannot wait for changes inside of a transaction."
...
.method public writeCopyTo(Ljava/io/File;)V
    ...
    .line 15
    .line 16
    const-string/jumbo v0, "The destination argument cannot be null"
...
.method public writeEncryptedCopyTo(Ljava/io/File;[B)V
    ...
    .line 14
    .line 15
    const-string/jumbo p2, "The destination argument cannot be null"
