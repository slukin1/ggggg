...
.method public static addChangeListener(Lio/realm/RealmModel;Lio/realm/RealmObjectChangeListener;)V
    ...
    const-string/jumbo p1, "Cannot add listener from this unmanaged RealmObject (created outside of Realm)"
    ...
    const-string/jumbo p1, "Listener should not be null"
    ...
    const-string/jumbo p1, "Object should not be null"
...
.method public static asChangesetObservable(Lio/realm/RealmModel;)Lio/reactivex/q;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
    ...
    invoke-interface {v1, v0, p0}, Lio/realm/rx/RxObservableFactory;->changesetsFrom(Lio/realm/Realm;Lio/realm/RealmModel;)Lio/reactivex/q;
    ...
    invoke-interface {v0, v1, p0}, Lio/realm/rx/RxObservableFactory;->changesetsFrom(Lio/realm/DynamicRealm;Lio/realm/DynamicRealmObject;)Lio/reactivex/q;
    ...
    const-string/jumbo v0, " does not support RxJava. See https://realm.io/docs/java/latest/#rxjava for more details."
    ...
    const-string/jumbo v0, "Cannot create Observables from unmanaged RealmObjects"
...
.method public static asFlowable(Lio/realm/RealmModel;)Lio/reactivex/f;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
    ...
    invoke-interface {v1, v0, p0}, Lio/realm/rx/RxObservableFactory;->from(Lio/realm/Realm;Lio/realm/RealmModel;)Lio/reactivex/f;
    ...
    invoke-interface {v0, v1, p0}, Lio/realm/rx/RxObservableFactory;->from(Lio/realm/DynamicRealm;Lio/realm/DynamicRealmObject;)Lio/reactivex/f;
...
.method public static deleteFromRealm(Lio/realm/RealmModel;)V
    ...
    const-string/jumbo v0, "Object malformed: missing Realm. Make sure to instantiate RealmObjects with Realm.createObject()"
    ...
    const-string/jumbo v0, "Object malformed: missing object in Realm. Make sure to instantiate RealmObjects with Realm.createObject()"
    ...
    const-string/jumbo v0, "Object not managed by Realm, so it cannot be removed."
...
.method public static freeze(Lio/realm/RealmModel;)Lio/realm/RealmModel;
    ...
    const-string/jumbo v1, "Unknown Realm type: "
    ...
    const-string/jumbo v0, "It is only possible to freeze valid managed Realm objects."
...
.method public static getRealm(Lio/realm/RealmModel;)Lio/realm/Realm;
    ...
    const-string/jumbo v0, "\'model\' is null."
...
.method public static removeAllChangeListeners(Lio/realm/RealmModel;)V
    ...
    const-string/jumbo v0, "Calling removeChangeListener on a closed Realm %s, make sure to close all listeners before closing the Realm."
    ...
    const-string/jumbo v0, "Cannot remove listeners from this unmanaged RealmObject (created outside of Realm)"
...
.method public static removeChangeListener(Lio/realm/RealmModel;Lio/realm/RealmObjectChangeListener;)V
    ...
    const-string/jumbo p1, "Cannot remove listener from this unmanaged RealmObject (created outside of Realm)"
...
.method public final asChangesetObservable()Lio/reactivex/q;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 1
    invoke-static {p0}, Lio/realm/RealmObject;->asChangesetObservable(Lio/realm/RealmModel;)Lio/reactivex/q;
...
.method public final asFlowable()Lio/reactivex/f;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 1
    invoke-static {p0}, Lio/realm/RealmObject;->asFlowable(Lio/realm/RealmModel;)Lio/reactivex/f;
