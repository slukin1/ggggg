...
.method static constructor <clinit>()V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "com.google.work"
...
.method public static getAccountChangeEvents(Landroid/content/Context;ILjava/lang/String;)Ljava/util/List;
    ...
    .line 51
    .line 52
    const-string/jumbo p2, "account change events retrieval"
...
.method public static removeAccount(Landroid/content/Context;Landroid/accounts/Account;)Landroid/os/Bundle;
    ...
    .line 36
    .line 37
    const-string/jumbo v1, "account removal"
...
.method public static requestGoogleAccountsAccess(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    .line 39
    .line 40
    const-string/jumbo v2, "google accounts access request"
    ...
    .line 91
    .line 92
    const-string/jumbo v3, "Invalid state. Shouldn\'t happen"
...
.method public static zza(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;JLjava/util/concurrent/Executor;)Lcom/google/android/gms/auth/TokenData;
    ...
    .line 1
    .line 2
    const-string/jumbo p4, "Calling this from your main thread can lead to deadlock"
    ...
    .line 6
    .line 7
    const-string/jumbo p4, "Scope cannot be empty or null."
    ...
    .line 71
    .line 72
    const-string/jumbo p6, "getTokenWithDetails"
...
.method static synthetic zzb(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/Context;Landroid/os/IBinder;)Lcom/google/android/gms/auth/TokenData;
    ...
    .line 11
    .line 12
    const-string/jumbo p1, "getTokenWithDetails"
    ...
    .line 20
    .line 21
    const-string/jumbo p1, "Service call returned null"
...
.method public static zze(Landroid/content/Context;Ljava/lang/String;J)V
    ...
    .line 1
    .line 2
    const-string/jumbo p2, "Calling this from your main thread can lead to deadlock"
    ...
    .line 51
    .line 52
    const-string/jumbo v0, "clear token"
...
.method private static zzg(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    .line 62
    .line 63
    const-string/jumbo v1, "getTokenWithDetails"
    ...
    .line 69
    .line 70
    const-string/jumbo p1, "Invalid state. Shouldn\'t happen"
...
.method private static zzh(Landroid/content/Context;Landroid/content/ComponentName;Lcom/google/android/gms/auth/zzk;JLjava/util/concurrent/Executor;)Ljava/lang/Object;
    ...
    .line 1
    .line 2
    const-string/jumbo p3, "GoogleAuthUtil"
    ...
    .line 69
    .line 70
    const-string/jumbo p2, "SecurityException while bind to auth service: %s"
    ...
    .line 76
    .line 77
    const-string/jumbo p2, "SecurityException while binding to Auth service."
...
.method private static zzi(Lcom/google/android/gms/tasks/Task;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 13
    .line 14
    const-string/jumbo p1, "Canceled while waiting for the task of %s to finish."
    ...
    .line 37
    .line 38
    const-string/jumbo p1, "Interrupted while waiting for the task of %s to finish."
    ...
    .line 72
    .line 73
    const-string/jumbo p1, "Unable to get a result for %s due to ExecutionException."
...
.method private static zzj(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 9
    .line 10
    const-string/jumbo v1, "Service call returned null."
...
.method private static zzl(Lcom/google/android/gms/common/api/ApiException;Ljava/lang/String;)V
    ...
    .line 16
    .line 17
    const-string/jumbo p0, "%s failed via GoogleAuthServiceClient, falling back to previous approach:\n%s"
...
.method private static zzn(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;Landroid/app/PendingIntent;)V
    ...
    .line 16
    .line 17
    const-string/jumbo v6, "[GoogleAuthUtil] error status:%s with method:%s"
    ...
    .line 256
    .line 257
    const-string/jumbo p4, "Recovery PendingIntent is missing on current Gms version: %s for method: %s. It should always be present on or above Gms version %s. This indicates a bug in Gms implementation."
...
.method private static zzo(Landroid/accounts/Account;)V
    ...
    .line 33
    .line 34
    const-string/jumbo v0, "Account type not supported"
    ...
    .line 41
    .line 42
    const-string/jumbo v0, "Account name cannot be empty!"
