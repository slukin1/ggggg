...
.method public static newChooseAccountIntent(Lcom/google/android/gms/common/AccountPicker$AccountChooserOptions;)Landroid/content/Intent;
    ...
    const-string/jumbo v1, "We only support hostedDomain filter for account chip styled account picker"
    ...
    const-string/jumbo v1, "Consent is only valid for account chip styled account picker"
    ...
    const-string/jumbo v1, "Making the selected account non-clickable is only supported for the THEME_DAY_NIGHT_GOOGLE_MATERIAL2, THEME_LIGHT_GOOGLE_MATERIAL3, THEME_DARK_GOOGLE_MATERIAL3 or THEME_DAY_NIGHT_GOOGLE_MATERIAL3 themes"
    ...
    const-string/jumbo v3, "alwaysPromptForAccount"
    ...
    const-string/jumbo v3, "descriptionTextOverride"
    ...
    const-string/jumbo p0, "first_party_options_bundle"
