...
.method public schedule(Lcom/google/android/datatransport/runtime/TransportContext;IZ)V
    ...
    const-string/jumbo v2, "backendName"
    ...
    const-string/jumbo v0, "attemptNumber"

    .line 11
    invoke-virtual {v1, v0, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string/jumbo v0, "AlarmManagerScheduler"
    ...
    const-string/jumbo p2, "Upload for context %s is already scheduled. Returning..."
    ...
    const-string/jumbo p1, "Scheduling upload for context %s in %dms(Backend next call timestamp %d). Attempt %d"
