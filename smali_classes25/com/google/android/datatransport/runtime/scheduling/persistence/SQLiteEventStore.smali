...
.method private convertToReason(I)Lcom/google/android/datatransport/runtime/firebase/transport/LogEventDropped$Reason;
    ...
    .line 65
    :cond_6
    const-string/jumbo v1, "%n is not valid. No matched LogEventDropped-Reason found. Treated it as REASON_UNKNOWN"
    ...
    .line 70
    .line 71
    const-string/jumbo v2, "SQLiteEventStore"
...
.method private ensureTransportContext(Landroid/database/sqlite/SQLiteDatabase;Lcom/google/android/datatransport/runtime/TransportContext;)J
    ...
    .line 21
    .line 22
    const-string/jumbo v2, "backend_name"
...
.method private getTransportContextId(Landroid/database/sqlite/SQLiteDatabase;Lcom/google/android/datatransport/runtime/TransportContext;)Ljava/lang/Long;
    ...
    .line 3
    .line 4
    const-string/jumbo v1, "backend_name = ? and priority = ?"
    ...
    .line 44
    .line 45
    const-string/jumbo v2, " and extras = ?"
    ...
    .line 62
    :cond_0
    const-string/jumbo p2, " and extras is null"
...
.method private synthetic lambda$cleanUp$12(JLandroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Integer;
    ...
    .line 9
    .line 10
    const-string/jumbo p2, "SELECT COUNT(*), transport_name FROM events WHERE timestamp_ms < ? GROUP BY transport_name"
...
.method private static synthetic lambda$ensureBeginTransaction$25(Ljava/lang/Throwable;)Ljava/lang/Object;
    ...
    .line 3
    .line 4
    const-string/jumbo v1, "Timed out while trying to acquire the lock."
...
.method private static synthetic lambda$getDb$0(Ljava/lang/Throwable;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 3
    .line 4
    const-string/jumbo v1, "Timed out while trying to open db."
...
.method private static synthetic lambda$getTimeWindow$22(JLandroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/datatransport/runtime/firebase/transport/TimeWindow;
    ...
    .line 4
    .line 5
    const-string/jumbo v1, "SELECT last_metrics_upload_ms FROM global_log_event_state LIMIT 1"
...
.method private synthetic lambda$hasPendingEventsFor$6(Lcom/google/android/datatransport/runtime/TransportContext;Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Boolean;
    ...
    .line 22
    .line 23
    const-string/jumbo v0, "SELECT 1 FROM events WHERE context_id = ? LIMIT 1"
...
.method private static synthetic lambda$loadActiveContexts$10(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    .line 4
    .line 5
    const-string/jumbo v1, "SELECT distinct t._id, t.backend_name, t.priority, t.extras FROM transport_contexts AS t, events AS e WHERE e.context_id = t._id"
...
.method private synthetic lambda$persist$1(Lcom/google/android/datatransport/runtime/EventInternal;Lcom/google/android/datatransport/runtime/TransportContext;Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Long;
    ...
    .line 56
    .line 57
    const-string/jumbo v7, "context_id"
    ...
    .line 218
    .line 219
    const-string/jumbo v4, "event_payloads"
    ...
    .line 284
    .line 285
    const-string/jumbo p2, "event_metadata"
...
.method private synthetic lambda$recordFailure$4(Ljava/lang/String;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    ...
    .line 21
    .line 22
    const-string/jumbo p2, "DELETE FROM events WHERE num_attempts >= 16"
...
.method private static synthetic lambda$recordLogEventDropped$18(Ljava/lang/String;Lcom/google/android/datatransport/runtime/firebase/transport/LogEventDropped$Reason;JLandroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    ...
    .line 13
    .line 14
    const-string/jumbo v1, "SELECT 1 FROM log_event_dropped WHERE log_source = ? AND reason = ?"
    ...
    .line 60
    .line 61
    const-string/jumbo p0, "events_dropped_count"
    ...
    .line 80
    .line 81
    const-string/jumbo v2, "UPDATE log_event_dropped SET events_dropped_count = events_dropped_count + "
    ...
    .line 88
    .line 89
    const-string/jumbo p2, " WHERE log_source = ? AND reason = ?"
...
.method private static synthetic lambda$recordNextCallTime$7(JLcom/google/android/datatransport/runtime/TransportContext;Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    ...
    .line 47
    .line 48
    const-string/jumbo p0, "backend_name"
...
.method private synthetic lambda$resetClientMetrics$23(Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "DELETE FROM log_event_dropped"
    ...
    .line 15
    .line 16
    const-string/jumbo v1, "UPDATE global_log_event_state SET last_metrics_upload_ms="
...
.method private loadMetadata(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/List;)Ljava/util/Map;
    ...
    .line 8
    .line 9
    const-string/jumbo v2, "event_id IN ("
    ...
    .line 54
    .line 55
    const-string/jumbo v3, "event_metadata"
...
.method public static synthetic o(JLandroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/datatransport/runtime/firebase/transport/TimeWindow;
    .locals 0
...
.method public static synthetic r(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Ljava/util/List;Lcom/google/android/datatransport/runtime/TransportContext;Landroid/database/Cursor;)Ljava/lang/Object;
    .locals 0
...
.method private readPayload(J)[B
    ...
    .line 5
    .line 6
    const-string/jumbo v1, "event_payloads"
...
.method public static synthetic y(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Landroid/database/Cursor;)Ljava/lang/Object;
    .locals 0
...
.method public getNextCallTime(Lcom/google/android/datatransport/runtime/TransportContext;)J
    ...
    .line 25
    .line 26
    const-string/jumbo v1, "SELECT next_request_ms FROM transport_contexts WHERE backend_name = ? and priority = ?"
...
.method public loadClientMetrics()Lcom/google/android/datatransport/runtime/firebase/transport/ClientMetrics;
    ...
    .line 12
    .line 13
    const-string/jumbo v3, "SELECT log_source, reason, events_dropped_count FROM log_event_dropped"
...
.method public persist(Lcom/google/android/datatransport/runtime/TransportContext;Lcom/google/android/datatransport/runtime/EventInternal;)Lcom/google/android/datatransport/runtime/scheduling/persistence/PersistedEvent;
    ...
    .line 25
    .line 26
    const-string/jumbo v1, "SQLiteEventStore"

    .line 27
    .line 28
    const-string/jumbo v2, "Storing event with priority=%s, name=%s for destination %s"
...
.method public recordFailure(Ljava/lang/Iterable;)V
    ...
    .line 17
    .line 18
    const-string/jumbo v1, "UPDATE events SET num_attempts = num_attempts + 1 WHERE _id in "
    ...
    .line 35
    .line 36
    const-string/jumbo v1, "SELECT COUNT(*), transport_name FROM events WHERE num_attempts >= 16 GROUP BY transport_name"
...
.method public recordSuccess(Ljava/lang/Iterable;)V
    ...
    .line 17
    .line 18
    const-string/jumbo v1, "DELETE FROM events WHERE _id in "
