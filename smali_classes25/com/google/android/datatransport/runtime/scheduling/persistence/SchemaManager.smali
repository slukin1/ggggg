...
.method static constructor <clinit>()V
    ...
    .line 6
    .line 7
    const-string/jumbo v1, "INSERT INTO global_log_event_state VALUES ("
...
.method private static synthetic lambda$static$0(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "CREATE TABLE events (_id INTEGER PRIMARY KEY, context_id INTEGER NOT NULL, transport_name TEXT NOT NULL, timestamp_ms INTEGER NOT NULL, uptime_ms INTEGER NOT NULL, payload BLOB NOT NULL, code INTEGER, num_attempts INTEGER NOT NULL,FOREIGN KEY (context_id) REFERENCES transport_contexts(_id) ON DELETE CASCADE)"
    ...
    .line 6
    .line 7
    const-string/jumbo v0, "CREATE TABLE event_metadata (_id INTEGER PRIMARY KEY, event_id INTEGER NOT NULL, name TEXT NOT NULL, value TEXT NOT NULL,FOREIGN KEY (event_id) REFERENCES events(_id) ON DELETE CASCADE)"
    ...
    .line 11
    .line 12
    const-string/jumbo v0, "CREATE TABLE transport_contexts (_id INTEGER PRIMARY KEY, backend_name TEXT NOT NULL, priority INTEGER NOT NULL, next_request_ms INTEGER NOT NULL)"
    ...
    .line 16
    .line 17
    const-string/jumbo v0, "CREATE INDEX events_backend_id on events(context_id)"
    ...
    .line 21
    .line 22
    const-string/jumbo v0, "CREATE UNIQUE INDEX contexts_backend_priority on transport_contexts(backend_name, priority)"
...
.method private static synthetic lambda$static$1(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "ALTER TABLE transport_contexts ADD COLUMN extras BLOB"
    ...
    .line 6
    .line 7
    const-string/jumbo v0, "CREATE UNIQUE INDEX contexts_backend_priority_extras on transport_contexts(backend_name, priority, extras)"
    ...
    .line 11
    .line 12
    const-string/jumbo v0, "DROP INDEX contexts_backend_priority"
...
.method private static synthetic lambda$static$2(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "ALTER TABLE events ADD COLUMN payload_encoding TEXT"
...
.method private static synthetic lambda$static$3(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "ALTER TABLE events ADD COLUMN inline BOOLEAN NOT NULL DEFAULT 1"
    ...
    .line 6
    .line 7
    const-string/jumbo v0, "DROP TABLE IF EXISTS event_payloads"
    ...
    .line 11
    .line 12
    const-string/jumbo v0, "CREATE TABLE event_payloads (sequence_num INTEGER NOT NULL, event_id INTEGER NOT NULL, bytes BLOB NOT NULL,FOREIGN KEY (event_id) REFERENCES events(_id) ON DELETE CASCADE,PRIMARY KEY (sequence_num, event_id))"
...
.method private static synthetic lambda$static$4(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "DROP TABLE IF EXISTS log_event_dropped"
    ...
    .line 6
    .line 7
    const-string/jumbo v0, "DROP TABLE IF EXISTS global_log_event_state"
    ...
    .line 11
    .line 12
    const-string/jumbo v0, "CREATE TABLE log_event_dropped (log_source VARCHAR(45) NOT NULL,reason INTEGER NOT NULL,events_dropped_count BIGINT NOT NULL,PRIMARY KEY(log_source, reason))"
    ...
    .line 16
    .line 17
    const-string/jumbo v0, "CREATE TABLE global_log_event_state (last_metrics_upload_ms BIGINT PRIMARY KEY)"
...
.method private upgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 33
    .line 34
    const-string/jumbo v2, "Migration from "
    ...
    .line 49
    .line 50
    const-string/jumbo p2, " was requested, but cannot be performed. Only "
    ...
    .line 61
    .line 62
    const-string/jumbo p2, " migrations are provided"
...
.method public onConfigure(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 7
    .line 8
    const-string/jumbo v2, "PRAGMA busy_timeout=0;"
...
.method public onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 1
    .line 2
    const-string/jumbo p2, "DROP TABLE events"
    ...
    .line 6
    .line 7
    const-string/jumbo p2, "DROP TABLE event_metadata"
    ...
    .line 11
    .line 12
    const-string/jumbo p2, "DROP TABLE transport_contexts"
    ...
    .line 16
    .line 17
    const-string/jumbo p2, "DROP TABLE IF EXISTS event_payloads"
    ...
    .line 21
    .line 22
    const-string/jumbo p2, "DROP TABLE IF EXISTS log_event_dropped"
    ...
    .line 26
    .line 27
    const-string/jumbo p2, "DROP TABLE IF EXISTS global_log_event_state"
