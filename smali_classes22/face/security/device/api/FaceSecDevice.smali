...
.method static synthetic access$000(Lface/security/device/api/FaceSecDevice;)V
    .locals 0
...
.method static synthetic access$100(Lface/security/device/api/FaceSecDevice;)V
    .locals 0
...
.method static synthetic access$200(Lface/security/device/api/FaceSecDevice;)V
    .locals 0
...
.method private static gtam()J
    ...
    .line 3
    .line 4
    const-string/jumbo v1, "reserved0"
...
.method private initCommonEx(Landroid/content/Context;Ljava/lang/String;Ljava/util/Map;Lface/security/device/api/FaceSecInitListener;)V
    ...
    .line 23
    .line 24
    invoke-interface {p4, p1}, Lface/security/device/api/FaceSecInitListener;->onInitFinish(I)V
    ...
    .line 70
    .line 71
    const-string/jumbo p4, "\u200bface.security.device.api.FaceSecDevice"

    .line 72
    .line 73
    .line 74
    invoke-direct {p2, p3, p4}, Lcom/didiglobal/booster/instrument/ShadowThread;-><init>(Ljava/lang/Runnable;Ljava/lang/String;)V
...
.method private initIDs()V
    ...
    .line 2
    :try_start_0
    const-string/jumbo v0, "face.security.device.api.SecurityID"
    ...
    .line 23
    .line 24
    iget-object v3, p0, Lface/security/device/api/FaceSecDevice;->ctx:Landroid/content/Context;
...
.method private isActiveMpThread(Ljava/util/Map;)V
    ...
    .line 11
    .line 12
    const-string/jumbo v1, "DataSwitch"
...
.method public getDeviceToken()Lface/security/device/api/FaceSecToken;
    ...
    .line 2
    new-instance v1, Lface/security/device/api/FaceSecToken;

    invoke-direct {v1}, Lface/security/device/api/FaceSecToken;-><init>()V

    .line 3
    iget v2, v0, Lface/security/device/api/FaceSecSession;->code:I

    iput v2, v1, Lface/security/device/api/FaceSecToken;->code:I

    .line 4
    iget-object v0, v0, Lface/security/device/api/FaceSecSession;->session:Ljava/lang/String;

    iput-object v0, v1, Lface/security/device/api/FaceSecToken;->token:Ljava/lang/String;
...
.method public getDeviceToken(Ljava/lang/String;)Lface/security/device/api/FaceSecToken;
    ...
    .line 7
    iget v1, p1, Lface/security/device/api/FaceSecSession;->code:I

    iput v1, v0, Lface/security/device/api/FaceSecToken;->code:I

    .line 8
    iget-object p1, p1, Lface/security/device/api/FaceSecSession;->session:Ljava/lang/String;

    iput-object p1, v0, Lface/security/device/api/FaceSecToken;->token:Ljava/lang/String;
...
.method public getSessionId()Lface/security/device/api/FaceSecSessionId;
    ...
    .line 5
    .line 6
    new-instance v0, Lface/security/device/api/FaceSecSessionId;

    .line 7
    .line 8
    .line 9
    invoke-direct {v0}, Lface/security/device/api/FaceSecSessionId;-><init>()V
    ...
    .line 12
    .line 13
    iput v1, v0, Lface/security/device/api/FaceSecSessionId;->code:I
    ...
    .line 16
    .line 17
    iput-object v1, v0, Lface/security/device/api/FaceSecSessionId;->sessionId:Ljava/lang/String;
...
.method public mp()V
    ...
    .line 18
    .line 19
    const-string/jumbo v2, "\u200bface.security.device.api.FaceSecDevice"
