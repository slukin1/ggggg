...
.method public static checksum(Ljava/io/File;Ljava/util/zip/Checksum;)Ljava/util/zip/Checksum;
    ...
    .line 43
    .line 44
    const-string/jumbo p1, "Checksums can\'t be computed on directories"
...
.method public static contentEquals(Ljava/io/File;Ljava/io/File;)Z
    ...
    .line 104
    .line 105
    const-string/jumbo p1, "Can\'t compare directories, only files"
...
.method public static copyDirectory(Ljava/io/File;Ljava/io/File;Ljava/io/FileFilter;Z)V
    ...
    const-string/jumbo p0, "\' exists but is not a directory"
...
.method public static copyFile(Ljava/io/File;Ljava/io/File;Z)V
    ...
    const-string/jumbo p1, "\' exists but is read-only"
    ...
    const-string/jumbo p0, "\' exists but is a directory"
...
.method public static copyFileToDirectory(Ljava/io/File;Ljava/io/File;Z)V
    ...
    const-string/jumbo p1, "\' is not a directory"
...
.method public static copyToDirectory(Ljava/io/File;Ljava/io/File;)V
    ...
    const-string/jumbo v1, "The source "
...
.method public static copyToDirectory(Ljava/lang/Iterable;Ljava/io/File;)V
    ...
    const-string/jumbo p1, "Sources must not be null"
...
.method private static doCopyDirectory(Ljava/io/File;Ljava/io/File;Ljava/io/FileFilter;ZLjava/util/List;)V
    ...
    .line 81
    .line 82
    const-string/jumbo p1, "\' directory cannot be created"
    ...
    .line 166
    .line 167
    const-string/jumbo p1, "\' cannot be written to"
    ...
    .line 186
    .line 187
    const-string/jumbo p3, "Failed to list contents of "
...
.method private static doCopyFile(Ljava/io/File;Ljava/io/File;Z)V
    ...
    .line 33
    .line 34
    const-string/jumbo v1, "\' exists but is a directory"
    ...
    .line 163
    .line 164
    const-string/jumbo v0, "\' Expected length: "
...
.method public static forceMkdir(Ljava/io/File;)V
    ...
    .line 27
    .line 28
    const-string/jumbo p0, " exists and is not a directory. Unable to create directory."
...
.method public static isFileNewer(Ljava/io/File;J)Z
    ...
    const-string/jumbo p1, "No specified file"
...
.method public static isFileNewer(Ljava/io/File;Ljava/io/File;)Z
    ...
    const-string/jumbo v1, "The reference file \'"
    ...
    const-string/jumbo p1, "No specified reference file"
...
.method public static isFileNewer(Ljava/io/File;Ljava/util/Date;)Z
    ...
    const-string/jumbo p1, "No specified date"
...
.method public static isSymlink(Ljava/io/File;)Z
    ...
    .line 4
    .line 5
    invoke-static {p0}, Lcom/appinio/socialshare/appinio_social_share/utils/a;->a(Ljava/io/File;)Ljava/nio/file/Path;
...
.method public static moveDirectory(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 90
    .line 91
    const-string/jumbo p0, "\' after copy to \'"
    ...
    .line 126
    .line 127
    const-string/jumbo p0, " to a subdirectory of itself: "
...
.method public static moveDirectoryToDirectory(Ljava/io/File;Ljava/io/File;Z)V
    ...
    .line 84
    .line 85
    const-string/jumbo p1, "\' does not exist [createDestDir="
    ...
    .line 107
    .line 108
    const-string/jumbo p1, "Destination directory must not be null"
...
.method public static openInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    .line 40
    .line 41
    const-string/jumbo p0, "\' cannot be read"
...
.method public static openOutputStream(Ljava/io/File;Z)Ljava/io/FileOutputStream;
    ...
    const-string/jumbo p0, "\' cannot be written to"
    ...
    const-string/jumbo v0, "\' could not be created"
...
.method public static toFiles([Ljava/net/URL;)[Ljava/io/File;
    ...
    .line 44
    .line 45
    const-string/jumbo v1, "URL could not be converted to a File: "
...
.method private static validateListFilesParameters(Ljava/io/File;Lorg/apache/commons/io/filefilter/IOFileFilter;)V
    ...
    .line 12
    .line 13
    const-string/jumbo p1, "Parameter \'fileFilter\' is null"
