...
.method public static computeCropRectFromAspectRatio(Landroid/util/Size;Landroid/util/Rational;)Landroid/graphics/Rect;
    ...
    .line 9
    .line 10
    const-string/jumbo p1, "Invalid view ratio."
...
.method public static createBitmapFromImageProxy(Landroidx/camera/core/ImageProxy;)Landroid/graphics/Bitmap;
    ...
    .line 28
    .line 29
    const-string/jumbo v2, "Incorrect image format of the input image proxy: "
    ...
    .line 40
    .line 41
    const-string/jumbo p0, ", only ImageFormat.YUV_420_888 and PixelFormat.RGBA_8888 are supported"
...
.method private static createBitmapFromJpegImage(Landroidx/camera/core/ImageProxy;)Landroid/graphics/Bitmap;
    ...
    .line 17
    .line 18
    const-string/jumbo v0, "Decode jpeg byte array failed"
...
.method public static createBitmapFromPlane([Landroidx/camera/core/ImageProxy$PlaneProxy;II)Landroid/graphics/Bitmap;
    ...
    .line 10
    :goto_0
    const-string/jumbo v3, "Expect a single plane"
    ...
    .line 27
    :goto_1
    const-string/jumbo v3, "Expect pixelStride=4"
    ...
    .line 44
    :goto_2
    const-string/jumbo v0, "Expect rowStride=width*4"
...
.method public static createDirectByteBuffer(Landroid/graphics/Bitmap;)Ljava/nio/ByteBuffer;
    ...
    .line 13
    :goto_0
    const-string/jumbo v1, "Only accept Bitmap with ARGB_8888 format for now."
...
.method private static cropJpegByteArray([BLandroid/graphics/Rect;I)[B
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "Decode byte array failed."
    ...
    .line 46
    .line 47
    const-string/jumbo p1, "Encode bitmap failed."
    ...
    .line 78
    .line 79
    const-string/jumbo v0, "Decode byte array failed with illegal argument."
...
.method public static jpegImageToJpegByteArray(Landroidx/camera/core/ImageProxy;Landroid/graphics/Rect;I)[B
    ...
    const-string/jumbo v0, "Incorrect image format of the input image proxy: "
...
.method public static yuvImageToJpegByteArray(Landroidx/camera/core/ImageProxy;Landroid/graphics/Rect;II)[B
    ...
    .line 73
    .line 74
    const-string/jumbo p1, "YuvImage failed to encode jpeg."
    ...
    .line 88
    .line 89
    const-string/jumbo p3, "Incorrect image format of the input image proxy: "
