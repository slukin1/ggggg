...
.method public constructor <init>(Landroid/content/Context;Landroidx/camera/core/CameraXConfig$Provider;)V
    ...
    .line 75
    .line 76
    const-string/jumbo v1, "CameraX-scheduler"
    ...
    .line 80
    .line 81
    const-string/jumbo v3, "\u200bandroidx.camera.core.CameraX"

    .line 82
    .line 83
    .line 84
    invoke-direct {p2, v1, v2, v3}, Lcom/didiglobal/booster/instrument/ShadowHandlerThread;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    .line 88
    .line 89
    invoke-static {p2, v3}, Lcom/didiglobal/booster/instrument/ShadowThread;->setThreadName(Ljava/lang/Thread;Ljava/lang/String;)Ljava/lang/Thread;
    ...
    .line 133
    .line 134
    const-string/jumbo p2, "CameraX is not configured properly. The most likely cause is you did not include a default implementation in your build such as \'camera-camera2\'."
...
.method private static getConfigProvider(Landroid/content/Context;)Landroidx/camera/core/CameraXConfig$Provider;
    ...
    .line 40
    .line 41
    const-string/jumbo v2, "androidx.camera.core.impl.MetadataHolderService.DEFAULT_CONFIG_PROVIDER"
    ...
    .line 50
    .line 51
    const-string/jumbo p0, "No default CameraXConfig.Provider specified in meta-data. The most likely cause is you did not include a default implementation in your build such as \'camera-camera2\'."
    ...
    .line 91
    :goto_1
    const-string/jumbo v2, "Failed to retrieve default CameraXConfig.Provider from meta-data"
...
.method private initInternal(Landroid/content/Context;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 14
    :goto_0
    const-string/jumbo v2, "CameraX.initInternal() should only be called once per instance"
...
.method private synthetic lambda$initAndRetryRecursively$2(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    ...
    .line 128
    .line 129
    const-string/jumbo v2, "Invalid app configuration provided. Missing UseCaseConfigFactory."
    ...
    .line 141
    .line 142
    const-string/jumbo v2, "Invalid app configuration provided. Missing CameraDeviceSurfaceManager."
    ...
    .line 154
    .line 155
    const-string/jumbo v2, "Invalid app configuration provided. Missing CameraFactory."
    ...
    .line 186
    .line 187
    const-string/jumbo v2, "Retry init. Start time "
    ...
    .line 245
    .line 246
    const-string/jumbo p1, "CameraX"

    .line 247
    .line 248
    const-string/jumbo p2, "The device might underreport the amount of the cameras. Finish the initialize task since we are already reaching the maximum number of retries."
...
.method private synthetic lambda$initInternal$0(Landroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    .line 13
    .line 14
    const-string/jumbo p1, "CameraX initInternal"
...
.method private synthetic lambda$shutdownInternal$4(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    .line 17
    .line 18
    const-string/jumbo p1, "CameraX shutdownInternal"
...
.method private shutdownInternal()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 60
    .line 61
    const-string/jumbo v2, "CameraX could not be shutdown when it is initializing."
...
.method public getCameraDeviceSurfaceManager()Landroidx/camera/core/impl/CameraDeviceSurfaceManager;
    ...
    .line 8
    .line 9
    const-string/jumbo v1, "CameraX not initialized yet."
