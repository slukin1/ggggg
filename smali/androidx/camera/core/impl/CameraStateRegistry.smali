...
.method private recalculateAvailableCameras()V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "CameraStateRegistry"
    ...
    .line 23
    .line 24
    const-string/jumbo v7, "Recalculating open cameras:\n"
    ...
    .line 189
    .line 190
    const-string/jumbo v4, "Open count: %d (Max allowed: %d)"
...
.method private updateAndVerifyState(Landroidx/camera/core/Camera;Landroidx/camera/core/impl/CameraInternal$State;)Landroidx/camera/core/impl/CameraInternal$State;
    ...
    .line 9
    .line 10
    const-string/jumbo v0, "Cannot update state of camera which has not yet been registered. Register with CameraStateRegistry.registerCamera()"
    ...
    .line 38
    :goto_1
    const-string/jumbo v1, "Cannot mark camera as opening until camera was successful at calling CameraStateRegistry.tryOpenCamera()"
...
.method public registerCamera(Landroidx/camera/core/Camera;Ljava/util/concurrent/Executor;Landroidx/camera/core/impl/CameraStateRegistry$OnConfigureAvailableListener;Landroidx/camera/core/impl/CameraStateRegistry$OnOpenAvailableListener;)V
    ...
    .line 20
    .line 21
    const-string/jumbo v3, "Camera is already registered: "
...
.method public tryOpenCamera(Landroidx/camera/core/Camera;)Z
    ...
    .line 12
    .line 13
    const-string/jumbo v2, "Camera must first be registered with registerCamera()"
    ...
    .line 20
    .line 21
    const-string/jumbo v2, "CameraStateRegistry"
    ...
    .line 108
    :goto_1
    const-string/jumbo v1, "CameraStateRegistry"
