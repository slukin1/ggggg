...
.method private static getDefaultMessage(I)Ljava/lang/String;
    ...
    .line 27
    :cond_0
    const-string/jumbo p0, "Failed to create CameraCharacteristics."
    ...
    .line 30
    :cond_1
    const-string/jumbo p0, "Some API 28 devices cannot access the camera when the device is in \"Do Not Disturb\" mode. The camera will not be accessible until \"Do Not Disturb\" mode is disabled."
    ...
    .line 33
    :cond_2
    const-string/jumbo p0, "The system-wide limit for number of open cameras has been reached, and more camera devices cannot be opened until previous instances are closed."
    ...
    .line 36
    :cond_3
    const-string/jumbo p0, "The camera device is in use already"
    ...
    .line 39
    :cond_4
    const-string/jumbo p0, "The camera device is currently in the error state; no further calls to it will succeed."
    ...
    .line 42
    :cond_5
    const-string/jumbo p0, "The camera device is removable and has been disconnected from the Android device, or the camera service has shut down the connection due to a higher-priority access request for the camera device."
    ...
    .line 45
    :cond_6
    const-string/jumbo p0, "The camera is disabled due to a device policy, and cannot be opened."
...
.method private static getProblemString(I)Ljava/lang/String;
    ...
    .line 32
    :cond_0
    const-string/jumbo p0, "CAMERA_CHARACTERISTICS_CREATION_ERROR"
    ...
    .line 35
    :cond_1
    const-string/jumbo p0, "CAMERA_UNAVAILABLE_DO_NOT_DISTURB"
    ...
    .line 38
    :cond_2
    const-string/jumbo p0, "CAMERA_DEPRECATED_HAL"
    ...
    .line 41
    :cond_3
    const-string/jumbo p0, "MAX_CAMERAS_IN_USE"
    ...
    .line 44
    :cond_4
    const-string/jumbo p0, "CAMERA_IN_USE"
    ...
    .line 47
    :cond_5
    const-string/jumbo p0, "CAMERA_ERROR"
    ...
    .line 50
    :cond_6
    const-string/jumbo p0, "CAMERA_DISCONNECTED"
    ...
    .line 53
    :cond_7
    const-string/jumbo p0, "CAMERA_DISABLED"
...
.method public static toCameraAccessExceptionCompat(Landroid/hardware/camera2/CameraAccessException;)Landroidx/camera/camera2/internal/compat/CameraAccessExceptionCompat;
    ...
    .line 11
    .line 12
    const-string/jumbo v0, "cameraAccessException should not be null"
