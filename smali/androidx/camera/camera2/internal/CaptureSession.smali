...
.method private getOutputConfigurationCompat(Landroidx/camera/core/impl/SessionConfig$OutputConfig;Ljava/util/Map;Ljava/lang/String;)Landroidx/camera/camera2/internal/compat/params/OutputConfigurationCompat;
    ...
    .line 113
    .line 114
    const-string/jumbo p3, "Requested dynamic range is not supported. Defaulting to STANDARD dynamic range profile.\nRequested dynamic range:\n  "
    ...
    .line 125
    .line 126
    const-string/jumbo p2, "CaptureSession"
...
.method private synthetic lambda$release$1(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    .line 23
    .line 24
    const-string/jumbo v1, "Release[session="
...
.method private static mergeOptions(Ljava/util/List;)Landroidx/camera/core/impl/Config;
    ...
    .line 71
    .line 72
    const-string/jumbo v7, "Detect conflicting option "
    ...
    .line 103
    .line 104
    const-string/jumbo v4, "CaptureSession"
...
.method private openCaptureSession(Ljava/util/List;Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 95
    .line 96
    const-string/jumbo p1, "CaptureSession"

    .line 97
    .line 98
    const-string/jumbo v4, "Opening capture session."
...
.method abortCaptures()V
    ...
    .line 44
    :try_start_2
    const-string/jumbo v2, "CaptureSession"
...
.method public close()V
    ...
    .line 61
    .line 62
    const-string/jumbo v3, "Unable to issue the request before close the capture session"
...
.method finishClose()V
    ...
    .line 7
    .line 8
    const-string/jumbo v0, "CaptureSession"
...
.method issueBurstCaptureRequest(Ljava/util/List;)I
    ...
    .line 13
    .line 14
    const-string/jumbo v1, "Skipping issueBurstCaptureRequest due to session closed"
    ...
    .line 40
    .line 41
    const-string/jumbo v5, "Issuing capture request."
    ...
    .line 74
    .line 75
    const-string/jumbo v6, "CaptureSession"

    .line 76
    .line 77
    const-string/jumbo v7, "Skipping issuing empty capture request."
    ...
    .line 110
    .line 111
    const-string/jumbo v8, "CaptureSession"
    ...
    .line 217
    .line 218
    const-string/jumbo v1, "Skipping issuing request without surface."
    ...
    .line 283
    .line 284
    invoke-direct {p1, p0}, Landroidx/camera/camera2/internal/d1;-><init>(Landroidx/camera/camera2/internal/CaptureSession;)V
    ...
    .line 329
    .line 330
    const-string/jumbo v1, "Skipping issuing burst request due to no valid request elements"
    ...
    .line 343
    .line 344
    const-string/jumbo v4, "Unable to access camera: "
...
.method public issueCaptureRequests(Ljava/util/List;)V
    ...
    .line 20
    .line 21
    const-string/jumbo v1, "Cannot issue capture request on a closed/released session."
    ...
    .line 48
    .line 49
    const-string/jumbo v2, "issueCaptureRequests() should not be possible in state: "
...
.method issueRepeatingCaptureRequests(Landroidx/camera/core/impl/SessionConfig;)I
    ...
    .line 9
    .line 10
    const-string/jumbo v2, "Skipping issueRepeatingCaptureRequests for no configuration case."
    ...
    .line 24
    .line 25
    const-string/jumbo v2, "Skipping issueRepeatingCaptureRequests due to session closed"
    ...
    .line 47
    .line 48
    const-string/jumbo v2, "Skipping issueRepeatingCaptureRequests for no surface."
    ...
    .line 92
    .line 93
    const-string/jumbo v3, "Issuing request for session."
    ...
    .line 140
    .line 141
    const-string/jumbo v2, "Skipping issuing empty request for session."
...
.method public open(Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSessionOpener;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 24
    .line 25
    const-string/jumbo p3, "Open not allowed in state: "
    ...
    .line 101
    .line 102
    invoke-direct {v1, p0, p1, p2}, Landroidx/camera/camera2/internal/e1;-><init>(Landroidx/camera/camera2/internal/CaptureSession;Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;)V
...
.method public release(Z)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 32
    .line 33
    const-string/jumbo v2, "Unable to abort captures."
    ...
    .line 62
    .line 63
    const-string/jumbo v2, "The Opener shouldn\'t null in state:"
    ...
    .line 98
    .line 99
    invoke-direct {p1, p0}, Landroidx/camera/camera2/internal/f1;-><init>(Landroidx/camera/camera2/internal/CaptureSession;)V
...
.method public setSessionConfig(Landroidx/camera/core/impl/SessionConfig;)V
    ...
    .line 20
    .line 21
    const-string/jumbo v1, "Session configuration cannot be set on a closed/released session."
    ...
    .line 50
    .line 51
    const-string/jumbo v1, "Does not have the proper configured lists"
    ...
    .line 59
    .line 60
    const-string/jumbo v1, "Attempting to submit CaptureRequest after setting"
