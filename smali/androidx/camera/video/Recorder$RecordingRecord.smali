...
.method public static synthetic b(Landroidx/camera/video/MediaStoreOutputOptions;Landroid/net/Uri;)V
    .locals 0
...
.method public static synthetic e(Landroidx/camera/video/OutputOptions;Landroid/os/ParcelFileDescriptor;ILandroidx/core/util/Consumer;)Landroid/media/MediaMuxer;
    .locals 0
...
.method private static synthetic lambda$initializeRecording$1(Landroidx/camera/video/OutputOptions;Landroid/os/ParcelFileDescriptor;ILandroidx/core/util/Consumer;)Landroid/media/MediaMuxer;
    ...
    .line 82
    .line 83
    const-string/jumbo p1, "MediaMuxer doesn\'t accept FileDescriptor as output destination."
    ...
    .line 190
    .line 191
    const-string/jumbo p3, "Unable to get path from uri "
    ...
    .line 235
    .line 236
    const-string/jumbo p1, "Unable to create MediaStore entry."
    ...
    .line 249
    .line 250
    const-string/jumbo p3, "Unable to create MediaStore entry by "
    ...
    .line 272
    .line 273
    const-string/jumbo p3, "Invalid output options type: "
...
.method private static synthetic lambda$initializeRecording$3(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    .line 11
    .line 12
    const-string/jumbo p0, "File scanning operation failed [path: %s]"
    ...
    .line 28
    .line 29
    const-string/jumbo p0, "File scan completed successfully [path: %s, URI: %s]"
...
.method private static synthetic lambda$initializeRecording$4(Landroidx/camera/video/MediaStoreOutputOptions;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 26
    .line 27
    new-instance p2, Landroidx/camera/video/d0;

    .line 28
    .line 29
    .line 30
    invoke-direct {p2}, Landroidx/camera/video/d0;-><init>()V
    ...
    .line 41
    .line 42
    const-string/jumbo p1, "Skipping media scanner scan. Unable to retrieve file path from URI: "
...
.method private static synthetic lambda$initializeRecording$5(Landroid/os/ParcelFileDescriptor;Landroid/net/Uri;)V
    ...
    .line 8
    .line 9
    const-string/jumbo v0, "Failed to close dup\'d ParcelFileDescriptor"
...
.method initializeRecording(Landroid/content/Context;)V
    ...
    .line 39
    .line 40
    new-instance v4, Landroidx/camera/video/z;

    .line 41
    .line 42
    .line 43
    invoke-direct {v4, v0, v3}, Landroidx/camera/video/z;-><init>(Landroidx/camera/video/OutputOptions;Landroid/os/ParcelFileDescriptor;)V
    ...
    .line 94
    .line 95
    new-instance p1, Landroidx/camera/video/a0;

    .line 96
    .line 97
    .line 98
    invoke-direct {p1, v0}, Landroidx/camera/video/a0;-><init>(Landroidx/camera/video/MediaStoreOutputOptions;)V
    ...
    .line 102
    :cond_3
    new-instance v1, Landroidx/camera/video/b0;

    .line 103
    .line 104
    .line 105
    invoke-direct {v1, v0, p1}, Landroidx/camera/video/b0;-><init>(Landroidx/camera/video/MediaStoreOutputOptions;Landroid/content/Context;)V
    ...
    .line 113
    .line 114
    invoke-direct {v2, v3}, Landroidx/camera/video/c0;-><init>(Landroid/os/ParcelFileDescriptor;)V
...
.method performOneTimeAudioSourceCreation(Landroidx/camera/video/internal/audio/AudioSettings;Ljava/util/concurrent/Executor;)Landroidx/camera/video/internal/audio/AudioSource;
    ...
    .line 30
    .line 31
    const-string/jumbo v0, "One-time audio source creation has already occurred for recording "
    ...
    .line 53
    .line 54
    const-string/jumbo v0, "Recording does not have audio enabled. Unable to create audio source for recording "
...
.method performOneTimeMediaMuxerCreation(ILandroidx/core/util/Consumer;)Landroid/media/MediaMuxer;
    ...
    .line 33
    .line 34
    const-string/jumbo v1, "Failed to create MediaMuxer by "
...
.method updateVideoRecordEvent(Landroidx/camera/video/VideoRecordEvent;)V
    ...
    .line 112
    .line 113
    invoke-direct {v2, p0, p1}, Landroidx/camera/video/e0;-><init>(Landroidx/camera/video/Recorder$RecordingRecord;Landroidx/camera/video/VideoRecordEvent;)V
    ...
    .line 132
    .line 133
    const-string/jumbo v2, "Attempted to update event listener with event from incorrect recording [Recording: "
