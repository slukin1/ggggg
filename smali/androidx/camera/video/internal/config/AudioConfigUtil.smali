...
.method public static resolveAudioMimeInfo(Landroidx/camera/video/MediaSpec;Landroidx/camera/video/internal/VideoValidatedEncoderProfilesProxy;)Landroidx/camera/video/internal/config/AudioMimeInfo;
    ...
    .line 37
    .line 38
    const-string/jumbo v4, "audio/none"
    ...
    .line 56
    .line 57
    const-string/jumbo p1, "EncoderProfiles contains undefined AUDIO mime type so cannot be used. May rely on fallback defaults to derive settings [chosen mime type: "
    ...
    .line 94
    .line 95
    const-string/jumbo v0, "MediaSpec contains OUTPUT_FORMAT_AUTO. Using EncoderProfiles to derive AUDIO settings [mime type: "
    ...
    .line 134
    .line 135
    const-string/jumbo v0, "MediaSpec audio mime/profile matches EncoderProfiles. Using EncoderProfiles to derive AUDIO settings [mime type: "
    ...
    .line 165
    .line 166
    const-string/jumbo p1, "MediaSpec audio mime or profile does not match EncoderProfiles, so EncoderProfiles settings cannot be used. May rely on fallback defaults to derive AUDIO settings [EncoderProfiles mime type: "
    ...
    .line 179
    .line 180
    const-string/jumbo p1, "), chosen mime type: "
...
.method static resolveAudioSource(Landroidx/camera/video/AudioSpec;)I
    ...
    .line 15
    .line 16
    const-string/jumbo v0, "Using default AUDIO source: "
...
.method static resolveAudioSourceFormat(Landroidx/camera/video/AudioSpec;)I
    ...
    .line 15
    .line 16
    const-string/jumbo v0, "Using default AUDIO source format: "
...
.method static scaleAndClampBitrate(IIIIILandroid/util/Range;)I
    ...
    .line 78
    .line 79
    const-string/jumbo p0, "Base Bitrate(%dbps) * Channel Count Ratio(%d / %d) * Sample Rate Ratio(%d / %d) = %d"
...
.method static selectSampleRateOrNearestSupported(Landroid/util/Range;III)I
    ...
    .line 14
    .line 15
    const-string/jumbo v5, "AudioConfigUtil"
    ...
    .line 36
    .line 37
    const-string/jumbo v2, "Hz is not supported by audio source with channel count "
    ...
    .line 44
    .line 45
    const-string/jumbo v2, " and source format "
    ...
    .line 71
    .line 72
    const-string/jumbo v2, "Hz is not in target range "
    ...
    .line 93
    .line 94
    const-string/jumbo v2, "Trying common sample rates in proximity order to target "
