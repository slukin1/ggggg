...
.method private constructor <init>(Landroidx/media3/common/SimpleBasePlayer$State$Builder;)V
    ...
    :goto_1
    const-string/jumbo v5, "Empty playlist only allowed in STATE_IDLE or STATE_ENDED"
    ...
    :goto_2
    const-string/jumbo v5, "Ads not allowed if playlist is empty"
    ...
    :goto_3
    const-string/jumbo v6, "currentMediaItemIndex must be less than playlist.size()"
    ...
    :goto_6
    const-string/jumbo v6, "PeriodData has less ad groups than adGroupIndex"
    ...
    :goto_7
    const-string/jumbo v5, "Ad group has less ads than adIndexInGroupIndex"
    ...
    :cond_a
    const-string/jumbo v0, "Player error only allowed in STATE_IDLE"
    ...
    const-string/jumbo v1, "isLoading only allowed when not in STATE_IDLE or STATE_ENDED"
