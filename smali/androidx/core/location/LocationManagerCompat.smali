...
.method private static registerGnssMeasurementsCallbackOnR(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
    ...
    .line 12
    .line 13
    const-string/jumbo v1, "android.location.GnssRequest$Builder"
    ...
    .line 52
    .line 53
    const-string/jumbo v7, "android.location.GnssRequest"
...
.method private static registerGnssStatusCallback(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    new-instance v4, Landroidx/core/location/p;

    invoke-direct {v4, p0, v3}, Landroidx/core/location/p;-><init>(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;)V
    ...
    const-string/jumbo p1, " appears to be blocked, please run registerGnssStatusCallback() directly on a Looper thread or ensure the main Looper is not blocked by this thread"
    ...
    const-string/jumbo p1, " is shutting down"
...
.method public static unregisterGnssMeasurementsCallback(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;)V
    ...
    .line 19
    .line 20
    invoke-static {p1}, Landroidx/core/location/o;->a(Ljava/lang/Object;)Landroid/location/GnssMeasurementsEvent$Callback;
