...
.method public static final fromSlice(Landroid/app/slice/Slice;)Landroidx/credentials/provider/PasswordCredentialEntry;
    ...
    .line 38
    .line 39
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_TYPE_DISPLAY_NAME"
    ...
    .line 52
    :cond_1
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_USER_NAME"
    ...
    .line 65
    :cond_2
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_CREDENTIAL_TYPE_DISPLAY_NAME"
    ...
    .line 78
    :cond_3
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_PROFILE_ICON"
    ...
    .line 91
    :cond_4
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_PENDING_INTENT"
    ...
    .line 104
    :cond_5
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_OPTION_ID"
    ...
    .line 117
    :cond_6
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_LAST_USED_TIME_MILLIS"
    ...
    .line 134
    :cond_7
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_AUTO_ALLOWED"
    ...
    .line 160
    :cond_8
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_AUTO_SELECT_FROM_OPTION"
    ...
    .line 171
    :cond_9
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_AFFILIATED_DOMAIN"
    ...
    .line 185
    :cond_a
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_DEDUPLICATION_ID"
    ...
    .line 199
    :cond_b
    const-string/jumbo v11, "androidx.credentials.provider.credentialEntry.SLICE_HINT_IS_DEFAULT_ICON_PREFERRED"
