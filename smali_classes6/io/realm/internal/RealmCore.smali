...
.method public static addNativeLibraryPath(Ljava/lang/String;)V
    ...
    .line 37
    .line 38
    const-string/jumbo v1, "Cannot set the library path!"
...
.method public static declared-synchronized loadLibrary(Landroid/content/Context;)V
    ...
    :cond_0
    :try_start_1
    const-string/jumbo v1, "realm-jni"

    .line 12
    .line 13
    const-string/jumbo v2, "10.19.0"
...
.method private static loadLibraryWindows()Ljava/lang/String;
    ...
    .line 12
    :goto_0
    const-string/jumbo v0, "realm_jni32d"

    .line 13
    .line 14
    const-string/jumbo v1, "realm_jni64d"
    ...
    .line 27
    .line 28
    const-string/jumbo v2, "!!! Realm debug version loaded. !!!\n"
    ...
    .line 34
    :cond_0
    const-string/jumbo v0, "realm_jni32"

    .line 35
    .line 36
    const-string/jumbo v1, "realm_jni64"
    ...
    .line 55
    .line 56
    const-string/jumbo v2, "Searched java.library.path="
    ...
    .line 78
    .line 79
    const-string/jumbo v1, "Couldn\'t load the Realm JNI library \'realm_jni32.dll or realm_jni64.dll\'. Please include the directory to the library in java.library.path."
...
.method private static resetLibraryPath()V
    ...
    .line 21
    .line 22
    const-string/jumbo v2, "Cannot reset the library path!"
