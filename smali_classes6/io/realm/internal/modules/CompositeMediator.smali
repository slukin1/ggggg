...
.method public varargs constructor <init>([Lio/realm/internal/RealmProxyMediator;)V
    ...
    .line 89
    .line 90
    const-string/jumbo v0, "It is not allowed for two different model classes to share the same internal name in Realm. The classes %s and %s are being included from the modules \'%s\' and \'%s\' and they share the same internal name \'%s\'."
...
.method private getMediator(Ljava/lang/Class;)Lio/realm/internal/RealmProxyMediator;
    ...
    const-string/jumbo p1, " is not part of the schema for this Realm"
