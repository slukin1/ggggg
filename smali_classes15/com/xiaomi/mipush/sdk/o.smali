...
.method public static a(Landroid/content/Context;Landroid/content/Intent;Landroid/net/Uri;)V
    ...
    const-string/jumbo v3, "awake online config"
...
.method public static final a(Landroid/content/Context;Lcom/xiaomi/push/jg;ZI)V
    ...
    const-string/jumbo p0, "send message fail, because msgBytes is null."
    ...
    const-string/jumbo v1, "action_help_ping"

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo v1, "extra_help_ping_switch"

    invoke-virtual {v0, v1, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string/jumbo p2, "extra_help_ping_frequency"

    invoke-virtual {v0, p2, p3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string/jumbo p2, "mipush_payload"

    invoke-virtual {v0, p2, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[B)Landroid/content/Intent;

    const-string/jumbo p1, "com.xiaomi.mipush.MESSAGE_CACHE"
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "ping message"
...
.method public static a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string/jumbo p2, "extra_help_aw_info"
    ...
    const-string/jumbo p3, "action_aw_app_logic"

    invoke-virtual {p2, p3}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo p3, "mipush_payload"
