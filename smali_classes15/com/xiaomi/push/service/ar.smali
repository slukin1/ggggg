...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/app/Notification;)V
    ...
    const-string/jumbo p3, "group show summary not get icon from "
    ...
    invoke-static {p4}, Lcom/xiaomi/push/service/i0;->a(Landroid/app/Notification;)Ljava/lang/String;
    ...
    invoke-static {p4, v1, v4}, Landroidx/browser/trusted/h;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;
    ...
    invoke-static {p1, p4}, Lu5/b;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/app/Notification$Builder;
    ...
    invoke-static {p4, v1}, Lcom/xiaomi/push/service/av;->a(Landroid/app/Notification$Builder;Z)Z
    ...
    invoke-static {p2, v2}, Lcom/meizu/cloud/pushsdk/notification/e;->a(Ljava/lang/String;I)Landroid/graphics/drawable/Icon;

    move-result-object v0

    invoke-static {p4, v0}, Lu5/a;->a(Landroid/app/Notification$Builder;Landroid/graphics/drawable/Icon;)Landroid/app/Notification$Builder;
    ...
    const-string/jumbo p3, "group show summary notify:"
...
.method private a(Landroid/app/Notification;)Z
    ...
    invoke-static {p1, v0, v1}, Lcom/xiaomi/push/bj;->a(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method private b(Landroid/content/Context;ILandroid/app/Notification;)V
    ...
    invoke-static {p1, v3}, Landroidx/browser/trusted/f;->a(Landroid/content/Context;Landroid/app/Notification;)Landroid/app/Notification$Builder;
...
.method private b(Landroid/app/Notification;)Z
    ...
    :cond_0
    const-string/jumbo v2, "push_src_group_time"
    ...
    const-string/jumbo v0, "pushmask_%s_%s"
...
.method public a(Landroid/content/Context;Landroid/app/Notification$Builder;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo p2, "pushmask_%s_%s"
