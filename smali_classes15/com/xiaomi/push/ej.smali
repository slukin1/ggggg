...
.method private a(Landroid/app/Service;Landroid/content/Intent;)V
    ...
    const-string/jumbo p2, "old version message"
    ...
    const-string/jumbo v0, "old version message "
    ...
    const-string/jumbo v0, "B get a incorrect message"
    ...
    const-string/jumbo p2, "play with service "
...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo p3, "B is not ready"
    ...
    const-string/jumbo p2, "com.xiaomi.mipush.sdk.WAKEUP"

    invoke-virtual {v1, p2}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo p2, "waker_pkgname"
    ...
    const-string/jumbo p2, "awake_info"
    ...
    invoke-static {p1, p4, p3, p2}, Lcom/xiaomi/push/dy;->a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    const/16 p2, 0x3ee

    const-string/jumbo p3, "The job is finished"
    ...
    const-string/jumbo p3, "argument error"
