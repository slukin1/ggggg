...
.method private static validateParams(Lcom/google/crypto/tink/proto/AesCtrHmacStreamingParams;)V
    ...
    .line 40
    .line 41
    const-string/jumbo v2, "Invalid HKDF hash type: "
    ...
    .line 109
    .line 110
    const-string/jumbo v0, "ciphertext_segment_size must be at least (derived_key_size + tag_size + NONCE_PREFIX_IN_BYTES + 2)"
...
.method public validateKey(Lcom/google/crypto/tink/proto/AesCtrHmacStreamingKey;)V
    ...
    const-string/jumbo v0, "key_value must have at least as many bits as derived keys"
    ...
    const-string/jumbo v0, "key_value must have at least 16 bytes"
