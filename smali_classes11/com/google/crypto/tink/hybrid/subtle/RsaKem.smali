...
.method static bigIntToByteArray(Ljava/math/BigInteger;I)[B
    ...
    .line 28
    .line 29
    const-string/jumbo p1, "Value is one-byte longer than the expected size, but its first byte is not 0"
    ...
    .line 62
    .line 63
    const-string/jumbo p0, "Value has invalid length, must be of length at most (%d + 1), but got %d"
...
.method static generateRsaKeyPair(I)Ljava/security/KeyPair;
    ...
    .line 18
    .line 19
    const-string/jumbo v1, "No support for RSA algorithm."
...
.method static validateRsaModulus(Ljava/math/BigInteger;)V
    ...
    .line 33
    .line 34
    const-string/jumbo p0, "RSA key must be of at least size %d bits, but got %d"
