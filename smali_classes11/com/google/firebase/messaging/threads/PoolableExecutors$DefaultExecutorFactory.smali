...
.method public executeOneOff(Ljava/lang/String;Ljava/lang/String;Lcom/google/firebase/messaging/threads/ThreadPriority;Ljava/lang/Runnable;)V
    ...
    .line 3
    .line 4
    const-string/jumbo p3, "\u200bcom.google.firebase.messaging.threads.PoolableExecutors$DefaultExecutorFactory"

    .line 5
    .line 6
    .line 7
    invoke-direct {p1, p4, p2, p3}, Lcom/didiglobal/booster/instrument/ShadowThread;-><init>(Ljava/lang/Runnable;Ljava/lang/String;Ljava/lang/String;)V
...
.method public newScheduledThreadPool(ILcom/google/firebase/messaging/threads/ThreadPriority;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    const-string/jumbo p2, "\u200bcom.google.firebase.messaging.threads.PoolableExecutors$DefaultExecutorFactory"
...
.method public newScheduledThreadPool(ILjava/util/concurrent/ThreadFactory;Lcom/google/firebase/messaging/threads/ThreadPriority;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 3
    invoke-static {p1, p2, p3}, Lcom/didiglobal/booster/instrument/ShadowExecutors;->newOptimizedScheduledThreadPool(ILjava/util/concurrent/ThreadFactory;Ljava/lang/String;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public newThreadPool(ILcom/google/firebase/messaging/threads/ThreadPriority;)Ljava/util/concurrent/ExecutorService;
    ...
    const-string/jumbo v0, "\u200bcom.google.firebase.messaging.threads.PoolableExecutors$DefaultExecutorFactory"
...
.method public newThreadPool(ILjava/util/concurrent/ThreadFactory;Lcom/google/firebase/messaging/threads/ThreadPriority;)Ljava/util/concurrent/ExecutorService;
    ...
    .line 4
    new-instance p3, Lcom/didiglobal/booster/instrument/ShadowThreadPoolExecutor;
    ...
    const-string/jumbo v8, "\u200bcom.google.firebase.messaging.threads.PoolableExecutors$DefaultExecutorFactory"
...
.method public newThreadPool(Lcom/google/firebase/messaging/threads/ThreadPriority;)Ljava/util/concurrent/ExecutorService;
    ...
    const-string/jumbo p1, "\u200bcom.google.firebase.messaging.threads.PoolableExecutors$DefaultExecutorFactory"

    .line 1
    invoke-static {p1}, Lcom/didiglobal/booster/instrument/ShadowExecutors;->newOptimizedCachedThreadPool(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
...
.method public newThreadPool(Ljava/util/concurrent/ThreadFactory;Lcom/google/firebase/messaging/threads/ThreadPriority;)Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-static {p1, p2}, Lcom/didiglobal/booster/instrument/ShadowExecutors;->newOptimizedCachedThreadPool(Ljava/util/concurrent/ThreadFactory;Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
...
.method public submitOneOff(Ljava/lang/String;Ljava/lang/String;Lcom/google/firebase/messaging/threads/ThreadPriority;Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
    ...
    .line 9
    .line 10
    const-string/jumbo p4, "\u200bcom.google.firebase.messaging.threads.PoolableExecutors$DefaultExecutorFactory"

    .line 11
    .line 12
    .line 13
    invoke-direct {p3, p1, p2, p4}, Lcom/didiglobal/booster/instrument/ShadowThread;-><init>(Ljava/lang/Runnable;Ljava/lang/String;Ljava/lang/String;)V

    .line 14
    .line 15
    .line 16
    invoke-static {p3, p4}, Lcom/didiglobal/booster/instrument/ShadowThread;->setThreadName(Ljava/lang/Thread;Ljava/lang/String;)Ljava/lang/Thread;
