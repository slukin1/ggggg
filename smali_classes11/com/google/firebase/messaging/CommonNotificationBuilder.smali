...
.method private static createContentIntent(Landroid/content/Context;Lcom/google/firebase/messaging/NotificationParams;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    ...
    .line 27
    .line 28
    const-string/jumbo p3, "gcm.n.analytics_data"
...
.method private static createMessagingPendingIntent(Landroid/content/Context;Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    .line 14
    .line 15
    const-string/jumbo v3, "com.google.firebase.iid.FirebaseInstanceIdReceiver"
...
.method public static createNotificationInfo(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/NotificationParams;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;
    ...
    const-string/jumbo p3, "gcm.n.title"
    ...
    :cond_0
    const-string/jumbo p3, "gcm.n.body"
    ...
    :cond_1
    const-string/jumbo p3, "gcm.n.icon"
    ...
    :cond_3
    const-string/jumbo p0, "gcm.n.color"
    ...
    :cond_4
    const-string/jumbo p0, "gcm.n.sticky"
    ...
    const-string/jumbo p0, "gcm.n.local_only"
    ...
    const-string/jumbo p0, "gcm.n.ticker"
    ...
    :cond_8
    const-string/jumbo p0, "gcm.n.event_time"
...
.method private static getColor(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    .line 21
    .line 22
    const-string/jumbo v1, "Color is invalid: "
    ...
    .line 29
    .line 30
    const-string/jumbo p1, ". Notification will use default color."
    ...
    .line 35
    :cond_0
    const-string/jumbo p1, "com.google.firebase.messaging.default_notification_color"
...
.method private static getConsolidatedDefaults(Lcom/google/firebase/messaging/NotificationParams;)I
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "gcm.n.default_sound"
    ...
    .line 7
    .line 8
    const-string/jumbo v1, "gcm.n.default_vibrate_timings"
    ...
    .line 18
    :cond_0
    const-string/jumbo v1, "gcm.n.default_light_settings"
...
.method private static getManifestMetadata(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .line 20
    .line 21
    const-string/jumbo v0, "Couldn\'t get own application info: "
...
.method public static getOrCreateChannel(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 53
    .line 54
    const-string/jumbo v2, "Notification Channel requested ("
    ...
    .line 61
    .line 62
    const-string/jumbo p1, ") has not been created by the app. Manifest configuration, or default, value will be used."
    ...
    .line 67
    :cond_3
    const-string/jumbo p1, "com.google.firebase.messaging.default_notification_channel_id"
    ...
    .line 103
    .line 104
    const-string/jumbo v3, "fcm_fallback_notification_channel_label"
...
.method private static getSmallIcon(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 50
    .line 51
    const-string/jumbo p3, " not found. Notification will use default icon."
    ...
    .line 56
    :cond_2
    const-string/jumbo p3, "com.google.firebase.messaging.default_notification_icon"
    ...
    .line 83
    .line 84
    const-string/jumbo p4, "Couldn\'t get own application info: "
...
.method private static getTag(Lcom/google/firebase/messaging/NotificationParams;)Ljava/lang/String;
    ...
    .line 19
    .line 20
    const-string/jumbo v0, "FCM-Notification:"
...
.method private static isValidIcon(Landroid/content/res/Resources;I)Z
    ...
    .line 41
    .line 42
    const-string/jumbo v0, "Couldn\'t find resource "
    ...
    .line 49
    .line 50
    const-string/jumbo p1, ", treating it as an invalid icon"
