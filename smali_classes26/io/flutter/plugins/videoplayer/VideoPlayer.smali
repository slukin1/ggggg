...
.field private httpDataSourceFactory:Landroidx/media3/datasource/DefaultHttpDataSource$Factory;
...
.method constructor <init>(Landroid/content/Context;Lio/flutter/plugin/common/EventChannel;Lio/flutter/view/TextureRegistry$SurfaceTextureEntry;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lio/flutter/plugins/videoplayer/VideoPlayerOptions;)V
    ...
    iput-object v0, p0, Lio/flutter/plugins/videoplayer/VideoPlayer;->httpDataSourceFactory:Landroidx/media3/datasource/DefaultHttpDataSource$Factory;
    ...
    .line 10
    new-instance p6, Landroidx/media3/datasource/DefaultDataSource$Factory;

    iget-object p7, p0, Lio/flutter/plugins/videoplayer/VideoPlayer;->httpDataSourceFactory:Landroidx/media3/datasource/DefaultHttpDataSource$Factory;

    invoke-direct {p6, p1, p7}, Landroidx/media3/datasource/DefaultDataSource$Factory;-><init>(Landroid/content/Context;Landroidx/media3/datasource/DataSource$Factory;)V

    .line 11
    invoke-direct {p0, p3, p6, p5}, Lio/flutter/plugins/videoplayer/VideoPlayer;->buildMediaSource(Landroid/net/Uri;Landroidx/media3/datasource/DataSource$Factory;Ljava/lang/String;)Landroidx/media3/exoplayer/source/MediaSource;
    ...
    invoke-direct {p0, p2, p1}, Lio/flutter/plugins/videoplayer/VideoPlayer;->setUpVideoPlayer(Landroidx/media3/exoplayer/ExoPlayer;Lio/flutter/plugins/videoplayer/QueuingEventSink;)V

    .line 15
    sget-object p1, Lio/flutter/plugins/videoplayer/VideoPlayerPlugin;->sOnPreparePlayListener:Lio/flutter/plugins/videoplayer/VideoPlayerPlugin$OnPreparePlayListener;

    if-eqz p1, :cond_0

    .line 16
    invoke-interface {p1, p4}, Lio/flutter/plugins/videoplayer/VideoPlayerPlugin$OnPreparePlayListener;->onPreparePlay(Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method constructor <init>(Landroidx/media3/exoplayer/ExoPlayer;Lio/flutter/plugin/common/EventChannel;Lio/flutter/view/TextureRegistry$SurfaceTextureEntry;Lio/flutter/plugins/videoplayer/VideoPlayerOptions;Lio/flutter/plugins/videoplayer/QueuingEventSink;Landroidx/media3/datasource/DefaultHttpDataSource$Factory;)V
    .locals 1
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
    ...
    .line 23
    iput-object p6, p0, Lio/flutter/plugins/videoplayer/VideoPlayer;->httpDataSourceFactory:Landroidx/media3/datasource/DefaultHttpDataSource$Factory;

    .line 24
    invoke-direct {p0, p1, p5}, Lio/flutter/plugins/videoplayer/VideoPlayer;->setUpVideoPlayer(Landroidx/media3/exoplayer/ExoPlayer;Lio/flutter/plugins/videoplayer/QueuingEventSink;)V

    return-void
.end method

.method private buildMediaSource(Landroid/net/Uri;Landroidx/media3/datasource/DataSource$Factory;Ljava/lang/String;)Landroidx/media3/exoplayer/source/MediaSource;
    .locals 6
    ...
    .line 15
    .line 16
    new-instance p3, Landroidx/media3/datasource/rtmp/RtmpDataSource$Factory;

    .line 17
    .line 18
    .line 19
    invoke-direct {p3}, Landroidx/media3/datasource/rtmp/RtmpDataSource$Factory;-><init>()V
    ...
    .line 38
    .line 39
    invoke-static {p1}, Landroidx/media3/common/util/Util;->inferContentType(Landroid/net/Uri;)I
    ...
    .line 126
    .line 127
    invoke-virtual {p3, p1}, Landroidx/media3/exoplayer/source/ProgressiveMediaSource$Factory;->createMediaSource(Landroidx/media3/common/MediaItem;)Landroidx/media3/exoplayer/source/ProgressiveMediaSource;
    ...
    .line 163
    .line 164
    invoke-virtual {p3, p1}, Landroidx/media3/exoplayer/hls/HlsMediaSource$Factory;->createMediaSource(Landroidx/media3/common/MediaItem;)Landroidx/media3/exoplayer/hls/HlsMediaSource;
    ...
    .line 168
    :cond_8
    new-instance p3, Landroidx/media3/exoplayer/smoothstreaming/SsMediaSource$Factory;
    ...
    .line 172
    .line 173
    invoke-direct {v0, p2}, Landroidx/media3/exoplayer/smoothstreaming/DefaultSsChunkSource$Factory;-><init>(Landroidx/media3/datasource/DataSource$Factory;)V

    .line 174
    .line 175
    .line 176
    invoke-direct {p3, v0, p2}, Landroidx/media3/exoplayer/smoothstreaming/SsMediaSource$Factory;-><init>(Landroidx/media3/exoplayer/smoothstreaming/SsChunkSource$Factory;Landroidx/media3/datasource/DataSource$Factory;)V
    ...
    .line 182
    .line 183
    invoke-virtual {p3, p1}, Landroidx/media3/exoplayer/smoothstreaming/SsMediaSource$Factory;->createMediaSource(Landroidx/media3/common/MediaItem;)Landroidx/media3/exoplayer/smoothstreaming/SsMediaSource;
    ...
    .line 187
    :cond_9
    new-instance p3, Landroidx/media3/exoplayer/dash/DashMediaSource$Factory;
    ...
    .line 191
    .line 192
    invoke-direct {v0, p2}, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;-><init>(Landroidx/media3/datasource/DataSource$Factory;)V

    .line 193
    .line 194
    .line 195
    invoke-direct {p3, v0, p2}, Landroidx/media3/exoplayer/dash/DashMediaSource$Factory;-><init>(Landroidx/media3/exoplayer/dash/DashChunkSource$Factory;Landroidx/media3/datasource/DataSource$Factory;)V
    ...
    .line 201
    .line 202
    invoke-virtual {p3, p1}, Landroidx/media3/exoplayer/dash/DashMediaSource$Factory;->createMediaSource(Landroidx/media3/common/MediaItem;)Landroidx/media3/exoplayer/dash/DashMediaSource;
...
.method private setUpVideoPlayer(Landroidx/media3/exoplayer/ExoPlayer;Lio/flutter/plugins/videoplayer/QueuingEventSink;)V
    .locals 2
    ...
    .line 41
    .line 42
    invoke-direct {v0, p0, p2, p1}, Lio/flutter/plugins/videoplayer/VideoPlayer$2;-><init>(Lio/flutter/plugins/videoplayer/VideoPlayer;Lio/flutter/plugins/videoplayer/QueuingEventSink;Landroidx/media3/exoplayer/ExoPlayer;)V
...
.method public buildHttpDataSourceFactory(Ljava/util/Map;)V
    ...
    .line 27
    :goto_0
    iget-object v3, p0, Lio/flutter/plugins/videoplayer/VideoPlayer;->httpDataSourceFactory:Landroidx/media3/datasource/DefaultHttpDataSource$Factory;
    ...
    .line 33
    .line 34
    invoke-virtual {v2, v1}, Landroidx/media3/datasource/DefaultHttpDataSource$Factory;->setAllowCrossProtocolRedirects(Z)Landroidx/media3/datasource/DefaultHttpDataSource$Factory;
    ...
    .line 37
    .line 38
    iget-object v0, p0, Lio/flutter/plugins/videoplayer/VideoPlayer;->httpDataSourceFactory:Landroidx/media3/datasource/DefaultHttpDataSource$Factory;
...
.method sendBufferingUpdate()V
    ...
    .line 8
    .line 9
    const-string/jumbo v2, "bufferingUpdate"
    ...
    .line 23
    .line 24
    iget-object v2, p0, Lio/flutter/plugins/videoplayer/VideoPlayer;->exoPlayer:Landroidx/media3/exoplayer/ExoPlayer;
...
.method sendInitialized()V
    ...
    .line 63
    .line 64
    invoke-interface {v2}, Landroidx/media3/exoplayer/ExoPlayer;->getVideoFormat()Landroidx/media3/common/Format;
    ...
    .line 68
    .line 69
    iget-object v3, p0, Lio/flutter/plugins/videoplayer/VideoPlayer;->exoPlayer:Landroidx/media3/exoplayer/ExoPlayer;

    .line 70
    .line 71
    .line 72
    invoke-interface {v3}, Landroidx/media3/exoplayer/ExoPlayer;->getVideoFormat()Landroidx/media3/common/Format;
    ...
    .line 98
    .line 99
    const-string/jumbo v2, "rotationCorrection"
