...
.method private static asyncWaitForVsync(J)V
    ...
    .line 11
    .line 12
    const-string/jumbo p1, "An AsyncWaitForVsyncDelegate must be registered with FlutterJNI before asyncWaitForVsync() is invoked."
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    .line 9
    .line 10
    invoke-static {p0}, Lcom/bumptech/glide/load/resource/bitmap/b;->a(Ljava/nio/ByteBuffer;)Landroid/graphics/ImageDecoder$Source;
    ...
    .line 18
    .line 19
    invoke-static {p0, v0}, Landroidx/core/graphics/w;->a(Landroid/graphics/ImageDecoder$Source;Landroid/graphics/ImageDecoder$OnHeaderDecodedListener;)Landroid/graphics/Bitmap;
    ...
    .line 23
    .line 24
    const-string/jumbo p1, "FlutterJNI"

    .line 25
    .line 26
    const-string/jumbo p2, "Failed to decode image"
...
.method private static synthetic lambda$decodeImage$0(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    .line 6
    .line 7
    invoke-static {p4}, Landroidx/core/graphics/b;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;
    ...
    .line 10
    .line 11
    invoke-static {p2, p4}, Lcom/bumptech/glide/load/resource/b;->a(Landroid/graphics/ImageDecoder;Landroid/graphics/ColorSpace;)V
    ...
    .line 14
    .line 15
    invoke-static {p2, p4}, Lcom/bumptech/glide/load/resource/a;->a(Landroid/graphics/ImageDecoder;I)V

    .line 16
    .line 17
    .line 18
    invoke-static {p3}, Lcom/bumptech/glide/load/resource/e;->a(Landroid/graphics/ImageDecoder$ImageInfo;)Landroid/util/Size;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    .line 15
    .line 16
    const-string/jumbo v1, "platformViewsController must be set before attempting to position an overlay surface"
...
.method public destroyOverlaySurface2()V
    ...
    .line 14
    .line 15
    const-string/jumbo v1, "platformViewsController must be set before attempting to destroy an overlay surface"
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    .line 33
    .line 34
    const-string/jumbo p1, ". Response ID: "
    ...
    .line 45
    .line 46
    const-string/jumbo p2, "FlutterJNI"
...
.method public dispatchPlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;II)V
    ...
    .line 30
    .line 31
    const-string/jumbo p3, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: "
...
.method public getScaledFontSize(FI)F
    ...
    .line 12
    .line 13
    const-string/jumbo v0, "getScaledFontSize called with configurationId "
    ...
    .line 24
    .line 25
    const-string/jumbo p2, ", which can\'t be found."
...
.method public init(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JI)V
    ...
    .line 5
    .line 6
    const-string/jumbo v0, "FlutterJNI"

    .line 7
    .line 8
    const-string/jumbo v1, "FlutterJNI.init called more than once"
...
.method public invokePlatformMessageEmptyResponseCallback(I)V
    ...
    .line 33
    .line 34
    const-string/jumbo v2, "Tried to send a platform message response, but FlutterJNI was detached from native C++. Could not send. Response ID: "
...
.method public invokePlatformMessageResponseCallback(ILjava/nio/ByteBuffer;I)V
    ...
    .line 81
    .line 82
    const-string/jumbo p2, "Expected a direct ByteBuffer."
...
.method public loadLibrary(Landroid/content/Context;)V
    ...
    .line 7
    .line 8
    const-string/jumbo v1, "FlutterJNI.loadLibrary called more than once"
...
.method public onBeginFrame()V
    ...
    .line 14
    .line 15
    const-string/jumbo v1, "platformViewsController must be set before attempting to begin the frame"
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    .line 19
    .line 20
    const-string/jumbo p2, "platformViewsController must be set before attempting to position an overlay surface"
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    .line 26
    .line 27
    const-string/jumbo v2, "platformViewsController must be set before attempting to position a platform view"
...
.method public onEndFrame()V
    ...
    .line 14
    .line 15
    const-string/jumbo v1, "platformViewsController must be set before attempting to end the frame"
...
.method public prefetchDefaultFontManager()V
    ...
    .line 7
    .line 8
    const-string/jumbo v1, "FlutterJNI.prefetchDefaultFontManager called more than once"
...
.method public requestDartDeferredLibrary(I)V
    ...
    .line 12
    .line 13
    const-string/jumbo v0, "No DeferredComponentManager found. Android setup must be completed before using split AOT deferred components."
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;J)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    .line 42
    :goto_0
    const-string/jumbo v2, "Failed to spawn new JNI connected shell from existing shell."
