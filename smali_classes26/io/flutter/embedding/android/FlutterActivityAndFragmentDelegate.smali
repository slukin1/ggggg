...
.method private delayFirstAndroidViewDraw(Lio/flutter/embedding/android/FlutterView;)V
    ...
    .line 43
    .line 44
    const-string/jumbo v0, "Cannot delay the first Android view draw when the render mode is not set to `RenderMode.surface`."
...
.method private doInitialFlutterViewRun()V
    ...
    .line 60
    .line 61
    const-string/jumbo v3, "Executing Dart entrypoint: "
    ...
    .line 74
    .line 75
    const-string/jumbo v3, ", library uri: "
    ...
    .line 99
    .line 100
    const-string/jumbo v3, ", and sending initial route: "
    ...
    .line 112
    :goto_0
    const-string/jumbo v3, "FlutterActivityAndFragmentDelegate"
...
.method cancelBackGesture()V
    ...
    .line 6
    .line 7
    const-string/jumbo v1, "FlutterActivityAndFragmentDelegate"
    ...
    .line 10
    .line 11
    const-string/jumbo v0, "Forwarding cancelBackGesture() to FlutterEngine."
    ...
    .line 26
    :cond_0
    const-string/jumbo v0, "Invoked cancelBackGesture() before FlutterFragment was attached to an Activity."
...
.method commitBackGesture()V
    ...
    .line 10
    .line 11
    const-string/jumbo v0, "Forwarding commitBackGesture() to FlutterEngine."
    ...
    .line 26
    :cond_0
    const-string/jumbo v0, "Invoked commitBackGesture() before FlutterFragment was attached to an Activity."
...
.method public detachFromFlutterEngine()V
    ...
    .line 22
    .line 23
    const-string/jumbo v2, "The internal FlutterEngine created by "
    ...
    .line 32
    .line 33
    const-string/jumbo v2, " has been attached to by another activity. To persist a FlutterEngine beyond the ownership of this activity, explicitly create a FlutterEngine"
...
.method public getAppComponent()Landroid/app/Activity;
    ...
    const-string/jumbo v1, "FlutterActivityAndFragmentDelegate\'s getAppComponent should only be queried after onAttach, when the host\'s activity should always be non-null"
...
.method onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 57
    :cond_0
    const-string/jumbo p1, "onActivityResult() invoked before FlutterFragment was attached to an Activity."
...
.method onAttach(Landroid/content/Context;)V
    ...
    .line 19
    .line 20
    const-string/jumbo p1, "FlutterActivityAndFragmentDelegate"

    .line 21
    .line 22
    const-string/jumbo v0, "Attaching FlutterEngine to the Activity that owns this delegate."
...
.method onBackPressed()V
    ...
    .line 10
    .line 11
    const-string/jumbo v0, "Forwarding onBackPressed() to FlutterEngine."
    ...
    .line 26
    :cond_0
    const-string/jumbo v0, "Invoked onBackPressed() before FlutterFragment was attached to an Activity."
...
.method onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;IZ)Landroid/view/View;
    ...
    .line 1
    .line 2
    const-string/jumbo p1, "Creating FlutterView."

    .line 3
    .line 4
    const-string/jumbo p2, "FlutterActivityAndFragmentDelegate"
    ...
    .line 124
    .line 125
    const-string/jumbo p1, "Attaching FlutterEngine to FlutterView."
...
.method onDestroyView()V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "FlutterActivityAndFragmentDelegate"
...
.method onDetach()V
    ...
    .line 31
    .line 32
    const-string/jumbo v0, "Detaching FlutterEngine from the Activity that owns this Fragment."
...
.method onNewIntent(Landroid/content/Intent;)V
    ...
    .line 10
    .line 11
    const-string/jumbo v0, "Forwarding onNewIntent() to FlutterEngine and sending pushRouteInformation message."
    ...
    .line 47
    :cond_0
    const-string/jumbo p1, "onNewIntent() invoked before FlutterFragment was attached to an Activity."
...
.method onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    .line 65
    :cond_0
    const-string/jumbo p1, "onRequestPermissionResult() invoked before FlutterFragment was attached to an Activity."
...
.method onRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    .line 3
    .line 4
    const-string/jumbo v1, "onRestoreInstanceState. Giving framework and plugins an opportunity to restore state."
...
.method onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 83
    .line 84
    const-string/jumbo v1, "enableOnBackInvokedCallbackState"
...
.method onUserLeaveHint()V
    ...
    .line 10
    .line 11
    const-string/jumbo v0, "Forwarding onUserLeaveHint() to FlutterEngine."
    ...
    .line 26
    :cond_0
    const-string/jumbo v0, "onUserLeaveHint() invoked before FlutterFragment was attached to an Activity."
...
.method onWindowFocusChanged(Z)V
    ...
    .line 9
    .line 10
    const-string/jumbo v1, "Received onWindowFocusChanged: "
...
.method setUpFlutterEngine()V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "Setting up FlutterEngine."
    ...
    .line 41
    .line 42
    const-string/jumbo v4, "The requested cached FlutterEngine did not exist in the FlutterEngineCache: \'"
    ...
    .line 127
    .line 128
    const-string/jumbo v4, "The requested cached FlutterEngineGroup did not exist in the FlutterEngineGroupCache: \'"
    ...
    .line 147
    :cond_4
    const-string/jumbo v0, "No preferred FlutterEngine was provided. Creating a new FlutterEngine for this FlutterFragment."
...
.method startBackGesture(Landroid/window/BackEvent;)V
    ...
    .line 10
    .line 11
    const-string/jumbo v0, "Forwarding startBackGesture() to FlutterEngine."
    ...
    .line 26
    :cond_0
    const-string/jumbo p1, "Invoked startBackGesture() before FlutterFragment was attached to an Activity."
...
.method updateBackGestureProgress(Landroid/window/BackEvent;)V
    ...
    .line 10
    .line 11
    const-string/jumbo v0, "Forwarding updateBackGestureProgress() to FlutterEngine."
    ...
    .line 26
    :cond_0
    const-string/jumbo p1, "Invoked updateBackGestureProgress() before FlutterFragment was attached to an Activity."
