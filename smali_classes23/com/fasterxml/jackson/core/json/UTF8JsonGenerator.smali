...
.method private final _outputRawMultiByteChar(I[CII)I
    ...
    .line 32
    .line 33
    const-string/jumbo p1, "Split surrogate on writeRaw() input (last character): first character 0x%4x"
...
.method private final _writeCustomStringSegment2(Ljava/lang/String;II)V
    ...
    const-string/jumbo v8, "Invalid custom escape definitions; custom escape not found for character code 0x"
    ...
    const-string/jumbo p2, ", although was supposed to have one"
...
.method public writeBinary(Lcom/fasterxml/jackson/core/Base64Variant;Ljava/io/InputStream;I)I
    ...
    const-string/jumbo v1, "Too few bytes available: missing "

    invoke-virtual {p2, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p2, p1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string/jumbo p1, " bytes (out of "
...
.method public writeString(Ljava/io/Reader;I)V
    ...
    const-string/jumbo p1, "null reader"
    ...
    const-string/jumbo p1, "Didn\'t read enough from reader"
