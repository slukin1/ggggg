...
.method private final getDefaultPhotoPathIfNull(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3
    .line 4
    const-string/jumbo p1, "me/photos"
...
.method private final getMimeContentType()Ljava/lang/String;
    ...
    .line 17
    .line 18
    const-string/jumbo v1, "multipart/form-data; boundary=%s"
...
.method private final parameterToString(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 40
    .line 41
    const-string/jumbo v0, "Unsupported parameter type."
...
.method private final processGraphObjectProperty(Ljava/lang/String;Ljava/lang/Object;Lcom/facebook/GraphRequest$KeyValueSerializer;Z)V
    ...
    .line 230
    .line 231
    const-string/jumbo p4, "The type of property "
    ...
    .line 238
    .line 239
    const-string/jumbo p1, " in the graph object is unknown. It won\'t be sent in the request."
...
.method private final processRequest(Lcom/facebook/GraphRequestBatch;Lcom/facebook/internal/Logger;ILjava/net/URL;Ljava/io/OutputStream;Z)V
    ...
    .line 6
    .line 7
    const-string/jumbo p5, "  Attachments:\n"
    ...
    .line 72
    :cond_2
    const-string/jumbo p6, "  Parameters:\n"
    ...
    .line 119
    .line 120
    const-string/jumbo p4, "batch_app_id"
    ...
    .line 144
    .line 145
    const-string/jumbo p2, "App ID was not specified at the request or Settings."
...
.method public final executeAndWait(Lcom/facebook/GraphRequest;)Lcom/facebook/GraphResponse;
    ...
    .line 26
    .line 27
    const-string/jumbo v0, "invalid state: expected a single response"
...
.method public final executeConnectionAndWait(Ljava/net/HttpURLConnection;Lcom/facebook/GraphRequestBatch;)Ljava/util/List;
    ...
    const-string/jumbo v0, "Received %d responses while expecting %d"
...
.method public final newCustomAudienceThirdPartyIdRequest(Lcom/facebook/AccessToken;Landroid/content/Context;Ljava/lang/String;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;
    ...
    const-string/jumbo v0, "/custom_audience_third_party_id"
    ...
    const-string/jumbo p2, "There is no access token and attribution identifiers could not be retrieved"
    ...
    :cond_5
    const-string/jumbo p2, "limit_event_usage"
    ...
    const-string/jumbo p2, "Facebook App ID cannot be determined"
...
.method public final newPlacesSearchRequest(Lcom/facebook/AccessToken;Landroid/location/Location;IILjava/lang/String;Lcom/facebook/GraphRequest$GraphJSONArrayCallback;)Lcom/facebook/GraphRequest;
    ...
    .line 12
    .line 13
    const-string/jumbo p2, "Either location or searchText must be specified."
    ...
    .line 101
    .line 102
    invoke-direct {v5, p6}, Lcom/facebook/s;-><init>(Lcom/facebook/GraphRequest$GraphJSONArrayCallback;)V
...
.method public final serializeToUrlConnection$facebook_core_release(Lcom/facebook/GraphRequestBatch;Ljava/net/HttpURLConnection;)V
    ...
    .line 10
    .line 11
    invoke-direct {v7, v1, v2}, Lcom/facebook/internal/Logger;-><init>(Lcom/facebook/LoggingBehavior;Ljava/lang/String;)V
    ...
    .line 17
    .line 18
    invoke-direct/range {p0 .. p1}, Lcom/facebook/GraphRequest$Companion;->isGzipCompressible(Lcom/facebook/GraphRequestBatch;)Z
    ...
    .line 28
    .line 29
    invoke-virtual {v5, v1}, Lcom/facebook/GraphRequestBatch;->get(I)Lcom/facebook/GraphRequest;
    ...
    .line 32
    .line 33
    invoke-virtual {v8}, Lcom/facebook/GraphRequest;->getHttpMethod()Lcom/facebook/HttpMethod;
    ...
    .line 51
    .line 52
    invoke-direct {v15, v0, v6}, Lcom/facebook/GraphRequest$Companion;->setConnectionContentType(Ljava/net/HttpURLConnection;Z)V
    ...
    .line 60
    .line 61
    invoke-virtual {v7, v9}, Lcom/facebook/internal/Logger;->append(Ljava/lang/String;)V
    ...
    .line 69
    .line 70
    invoke-virtual {v7, v9, v10}, Lcom/facebook/internal/Logger;->appendKeyValue(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 74
    .line 75
    invoke-virtual {v7, v9, v14}, Lcom/facebook/internal/Logger;->appendKeyValue(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :goto_1
    :try_start_2
    invoke-direct/range {p0 .. p1}, Lcom/facebook/GraphRequest$Companion;->hasOnProgressCallbacks(Lcom/facebook/GraphRequestBatch;)Z
    ...
    .line 179
    .line 180
    invoke-direct/range {v8 .. v14}, Lcom/facebook/GraphRequest$Companion;->processRequest(Lcom/facebook/GraphRequestBatch;Lcom/facebook/internal/Logger;ILjava/net/URL;Ljava/io/OutputStream;Z)V
    ...
    .line 211
    :try_start_3
    invoke-direct/range {v0 .. v6}, Lcom/facebook/GraphRequest$Companion;->processRequest(Lcom/facebook/GraphRequestBatch;Lcom/facebook/internal/Logger;ILjava/net/URL;Ljava/io/OutputStream;Z)V
    :try_end_3
...
.method public final toHttpConnection(Lcom/facebook/GraphRequestBatch;)Ljava/net/HttpURLConnection;
    ...
    const-string/jumbo v1, "could not construct URL for request"
...
.method public final validateFieldsParamForGetRequests$facebook_core_release(Lcom/facebook/GraphRequestBatch;)V
    ...
    .line 52
    .line 53
    const-string/jumbo v4, "GET requests for /"
    ...
    .line 68
    .line 69
    const-string/jumbo v0, " should contain an explicit \"fields\" parameter."
