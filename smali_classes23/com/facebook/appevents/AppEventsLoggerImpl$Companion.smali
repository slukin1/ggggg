...
.method private static final initializeLib$lambda-4(Landroid/content/Context;Lcom/facebook/appevents/AppEventsLoggerImpl;)V
    ...
    .line 8
    .line 9
    const-string/jumbo v2, "com.facebook.login.Login"

    .line 10
    .line 11
    const-string/jumbo v3, "com.facebook.share.Share"

    .line 12
    .line 13
    const-string/jumbo v4, "com.facebook.places.Places"

    .line 14
    .line 15
    const-string/jumbo v5, "com.facebook.messenger.Messenger"

    .line 16
    .line 17
    const-string/jumbo v6, "com.facebook.applinks.AppLinks"

    .line 18
    .line 19
    const-string/jumbo v7, "com.facebook.marketing.Marketing"

    .line 20
    .line 21
    const-string/jumbo v8, "com.facebook.gamingservices.GamingServices"

    .line 22
    .line 23
    const-string/jumbo v9, "com.facebook.all.All"

    .line 24
    .line 25
    const-string/jumbo v10, "com.android.billingclient.api.BillingClient"

    .line 26
    .line 27
    const-string/jumbo v11, "com.android.vending.billing.IInAppBillingService"
    ...
    .line 34
    .line 35
    const-string/jumbo v3, "login_lib_included"
    ...
    .line 38
    .line 39
    const-string/jumbo v5, "places_lib_included"

    .line 40
    .line 41
    const-string/jumbo v6, "messenger_lib_included"

    .line 42
    .line 43
    const-string/jumbo v7, "applinks_lib_included"

    .line 44
    .line 45
    const-string/jumbo v8, "marketing_lib_included"

    .line 46
    .line 47
    const-string/jumbo v9, "gamingservices_lib_included"

    .line 48
    .line 49
    const-string/jumbo v10, "all_lib_included"

    .line 50
    .line 51
    const-string/jumbo v11, "billing_client_lib_included"

    .line 52
    .line 53
    const-string/jumbo v12, "billing_service_lib_included"
    ...
    .line 108
    .line 109
    const-string/jumbo p0, "fb_sdk_initialize"
...
.method private final initializeTimersIfNeeded()V
    ...
    :cond_0
    :try_start_1
    new-instance v1, Lcom/didiglobal/booster/instrument/ShadowScheduledThreadPoolExecutor;

    .line 16
    .line 17
    .line 18
    const-string/jumbo v2, "\u200bcom.facebook.appevents.AppEventsLoggerImpl$Companion"
    ...
    .line 21
    .line 22
    invoke-direct {v1, v3, v2, v3}, Lcom/didiglobal/booster/instrument/ShadowScheduledThreadPoolExecutor;-><init>(ILjava/lang/String;Z)V
...
.method private final logEvent(Lcom/facebook/appevents/AppEvent;Lcom/facebook/appevents/AccessTokenAppIdPair;)V
    ...
    .line 43
    .line 44
    const-string/jumbo p2, "fb_mobile_activate_app"
    ...
    .line 62
    .line 63
    const-string/jumbo v1, "Warning: Please call AppEventsLogger.activateApp(...)from the long-lived activity\'s onResume() methodbefore logging other app events."
...
.method public final activateApp(Landroid/app/Application;Ljava/lang/String;)V
    ...
    .line 28
    .line 29
    const-string/jumbo p2, "The Facebook sdk must be initialized before calling activateApp"
...
.method public final augmentWebView(Landroid/webkit/WebView;Landroid/content/Context;)V
    ...
    .line 92
    .line 93
    const-string/jumbo v1, "augmentWebView is only available for Android SDK version >= 17 on devices running Android >= 4.2"
...
.method public final functionDEPRECATED(Ljava/lang/String;)V
    ...
    .line 4
    .line 5
    const-string/jumbo v0, "This function is deprecated. "
