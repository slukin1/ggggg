...
.method public static final getApplicationId()Ljava/lang/String;
    ...
    .line 11
    .line 12
    const-string/jumbo v1, "A valid Facebook app id must be set in the AndroidManifest.xml or set by calling FacebookSdk.setApplicationId before initializing the sdk."
...
.method public static final getClientToken()Ljava/lang/String;
    ...
    .line 11
    .line 12
    const-string/jumbo v1, "A valid Facebook client token must be set in the AndroidManifest.xml or set by calling FacebookSdk.setClientToken before initializing the sdk. Visit https://developers.facebook.com/docs/android/getting-started#add-app_id for more information."
...
.method public static final getGraphApiVersion()Ljava/lang/String;
    ...
    .line 19
    .line 20
    const-string/jumbo v2, "getGraphApiVersion: %s"
...
.method public static final getLimitEventAndDataUsage(Landroid/content/Context;)Z
    ...
    .line 11
    .line 12
    const-string/jumbo v0, "limitEventUsage"
...
.method public static final loadDefaultsFromMetadata$facebook_core_release(Landroid/content/Context;)V
    ...
    .line 75
    .line 76
    const-string/jumbo v0, "App Ids cannot be directly placed in the manifest.They must be prefixed by \'fb\' or be placed in the string resource file."
    ...
    .line 118
    .line 119
    const-string/jumbo v3, "com.facebook.sdk.CallbackOffset"
    ...
    .line 132
    .line 133
    const-string/jumbo v0, "com.facebook.sdk.CodelessDebugLogEnabled"
...
.method private final publishInstallAndWaitForResponse(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 53
    .line 54
    const-string/jumbo v0, "%s/activities"
    ...
    .line 109
    .line 110
    const-string/jumbo v1, "MOBILE_APP_INSTALL has been logged"
    ...
    .line 118
    .line 119
    const-string/jumbo v0, "An error occurred while publishing install."
    ...
    .line 128
    :try_start_3
    const-string/jumbo p2, "Facebook-publish"
...
.method public static final publishInstallAsync(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 19
    .line 20
    const-string/jumbo v1, "app_events_killswitch"
    ...
    .line 39
    .line 40
    invoke-direct {v2, p0, p1}, Lcom/facebook/g;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 60
    .line 61
    const-string/jumbo p0, "com.facebook.sdk.attributionTracking"
...
.method public static final declared-synchronized sdkInitialize(Landroid/content/Context;ILcom/facebook/FacebookSdk$InitializeCallback;)V
    ...
    const-string/jumbo p1, "The callback request code offset can\'t be updated once the SDK is initialized. Call FacebookSdk.setCallbackRequestCodeOffset inside your Application.onCreate method"
    ...
    const-string/jumbo p1, "The callback request code offset can\'t be negative."
...
.method public static final declared-synchronized sdkInitialize(Landroid/content/Context;Lcom/facebook/FacebookSdk$InitializeCallback;)V
    ...
    const-string/jumbo p1, "A valid Facebook app client token must be set in the AndroidManifest.xml or set by calling FacebookSdk.setClientToken before initializing the sdk."
    ...
    const-string/jumbo p1, "A valid Facebook app id must be set in the AndroidManifest.xml or set by calling FacebookSdk.setApplicationId before initializing the sdk."
...
.method public static final setDataProcessingOptions([Ljava/lang/String;II)V
    ...
    const-string/jumbo v0, "data_processing_options"
    ...
    const-string/jumbo p0, "data_processing_options_country"

    .line 6
    invoke-virtual {v3, p0, p1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string/jumbo p0, "data_processing_options_state"
    ...
    const-string/jumbo p1, "com.facebook.sdk.DataProcessingOptions"
