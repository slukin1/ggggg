...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lcom/datadog/android/rum/model/ViewEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ViewEvent$Cellular;)V",
        "getCellular",
        "()Lcom/datadog/android/rum/model/ViewEvent$Cellular;",
        "getInterfaces",
        "()Ljava/util/List;",
...
.method public constructor <init>(Lcom/datadog/android/rum/model/ViewEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ViewEvent$Cellular;)V
    .locals 0
    .param p1    # Lcom/datadog/android/rum/model/ViewEvent$Status;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p2    # Ljava/util/List;
        ...
        .end annotation
    .end param
    .param p3    # Lcom/datadog/android/rum/model/ViewEvent$Cellular;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
...
.method public synthetic constructor <init>(Lcom/datadog/android/rum/model/ViewEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ViewEvent$Cellular;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 5
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;-><init>(Lcom/datadog/android/rum/model/ViewEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ViewEvent$Cellular;)V

    return-void
.end method

.method public static synthetic copy$default(Lcom/datadog/android/rum/model/ViewEvent$Connectivity;Lcom/datadog/android/rum/model/ViewEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ViewEvent$Cellular;ILjava/lang/Object;)Lcom/datadog/android/rum/model/ViewEvent$Connectivity;
    .locals 0
    ...
    .line 5
    .line 6
    iget-object p1, p0, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;->status:Lcom/datadog/android/rum/model/ViewEvent$Status;
    ...
    .line 11
    .line 12
    iget-object p2, p0, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;->interfaces:Ljava/util/List;
    ...
    .line 17
    .line 18
    iget-object p3, p0, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;->cellular:Lcom/datadog/android/rum/model/ViewEvent$Cellular;

    .line 19
    .line 20
    .line 21
    :cond_2
    invoke-virtual {p0, p1, p2, p3}, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;->copy(Lcom/datadog/android/rum/model/ViewEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ViewEvent$Cellular;)Lcom/datadog/android/rum/model/ViewEvent$Connectivity;
...
.method public static final fromJson(Ljava/lang/String;)Lcom/datadog/android/rum/model/ViewEvent$Connectivity;
    .locals 1
    ...
    .line 1
    .line 2
    sget-object v0, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;->Companion:Lcom/datadog/android/rum/model/ViewEvent$Connectivity$Companion;

    .line 3
    .line 4
    .line 5
    invoke-virtual {v0, p0}, Lcom/datadog/android/rum/model/ViewEvent$Connectivity$Companion;->fromJson(Ljava/lang/String;)Lcom/datadog/android/rum/model/ViewEvent$Connectivity;
...
.method public static final fromJsonObject(Lcom/google/gson/JsonObject;)Lcom/datadog/android/rum/model/ViewEvent$Connectivity;
    .locals 1
    ...
    .line 4
    .line 5
    invoke-virtual {v0, p0}, Lcom/datadog/android/rum/model/ViewEvent$Connectivity$Companion;->fromJsonObject(Lcom/google/gson/JsonObject;)Lcom/datadog/android/rum/model/ViewEvent$Connectivity;
...
# virtual methods
.method public final component1()Lcom/datadog/android/rum/model/ViewEvent$Status;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public final component3()Lcom/datadog/android/rum/model/ViewEvent$Cellular;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
...
.method public final copy(Lcom/datadog/android/rum/model/ViewEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ViewEvent$Cellular;)Lcom/datadog/android/rum/model/ViewEvent$Connectivity;
    .locals 1
    .param p1    # Lcom/datadog/android/rum/model/ViewEvent$Status;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 1
    .line 2
    new-instance v0, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;

    .line 3
    .line 4
    .line 5
    invoke-direct {v0, p1, p2, p3}, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;-><init>(Lcom/datadog/android/rum/model/ViewEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ViewEvent$Cellular;)V
...
.method public toString()Ljava/lang/String;
    ...
    .line 5
    .line 6
    iget-object v2, p0, Lcom/datadog/android/rum/model/ViewEvent$Connectivity;->cellular:Lcom/datadog/android/rum/model/ViewEvent$Cellular;
