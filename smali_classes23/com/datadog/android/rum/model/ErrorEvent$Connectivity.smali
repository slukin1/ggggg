...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lcom/datadog/android/rum/model/ErrorEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ErrorEvent$Cellular;)V",
        "getCellular",
        "()Lcom/datadog/android/rum/model/ErrorEvent$Cellular;",
        "getInterfaces",
        "()Ljava/util/List;",
...
.method public constructor <init>(Lcom/datadog/android/rum/model/ErrorEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ErrorEvent$Cellular;)V
    .locals 0
    .param p1    # Lcom/datadog/android/rum/model/ErrorEvent$Status;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p2    # Ljava/util/List;
        ...
        .end annotation
    .end param
    .param p3    # Lcom/datadog/android/rum/model/ErrorEvent$Cellular;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
...
.method public synthetic constructor <init>(Lcom/datadog/android/rum/model/ErrorEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ErrorEvent$Cellular;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 5
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;-><init>(Lcom/datadog/android/rum/model/ErrorEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ErrorEvent$Cellular;)V

    return-void
.end method

.method public static synthetic copy$default(Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;Lcom/datadog/android/rum/model/ErrorEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ErrorEvent$Cellular;ILjava/lang/Object;)Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;
    .locals 0
    ...
    .line 5
    .line 6
    iget-object p1, p0, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;->status:Lcom/datadog/android/rum/model/ErrorEvent$Status;
    ...
    .line 11
    .line 12
    iget-object p2, p0, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;->interfaces:Ljava/util/List;
    ...
    .line 17
    .line 18
    iget-object p3, p0, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;->cellular:Lcom/datadog/android/rum/model/ErrorEvent$Cellular;

    .line 19
    .line 20
    .line 21
    :cond_2
    invoke-virtual {p0, p1, p2, p3}, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;->copy(Lcom/datadog/android/rum/model/ErrorEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ErrorEvent$Cellular;)Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;
...
.method public static final fromJson(Ljava/lang/String;)Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;
    .locals 1
    ...
    .line 1
    .line 2
    sget-object v0, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;->Companion:Lcom/datadog/android/rum/model/ErrorEvent$Connectivity$Companion;

    .line 3
    .line 4
    .line 5
    invoke-virtual {v0, p0}, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity$Companion;->fromJson(Ljava/lang/String;)Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;
...
.method public static final fromJsonObject(Lcom/google/gson/JsonObject;)Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;
    .locals 1
    ...
    .line 4
    .line 5
    invoke-virtual {v0, p0}, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity$Companion;->fromJsonObject(Lcom/google/gson/JsonObject;)Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;
...
# virtual methods
.method public final component1()Lcom/datadog/android/rum/model/ErrorEvent$Status;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public final component2()Ljava/util/List;
    ...
    .line 1
    .line 2
    iget-object v0, p0, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;->interfaces:Ljava/util/List;
...
.method public final component3()Lcom/datadog/android/rum/model/ErrorEvent$Cellular;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
    ...
    .line 1
    .line 2
    iget-object v0, p0, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;->cellular:Lcom/datadog/android/rum/model/ErrorEvent$Cellular;
...
.method public final copy(Lcom/datadog/android/rum/model/ErrorEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ErrorEvent$Cellular;)Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;
    .locals 1
    .param p1    # Lcom/datadog/android/rum/model/ErrorEvent$Status;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 4
    .line 5
    invoke-direct {v0, p1, p2, p3}, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;-><init>(Lcom/datadog/android/rum/model/ErrorEvent$Status;Ljava/util/List;Lcom/datadog/android/rum/model/ErrorEvent$Cellular;)V
...
.method public final getCellular()Lcom/datadog/android/rum/model/ErrorEvent$Cellular;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
...
.method public final getStatus()Lcom/datadog/android/rum/model/ErrorEvent$Status;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public toString()Ljava/lang/String;
    ...
    .line 5
    .line 6
    iget-object v2, p0, Lcom/datadog/android/rum/model/ErrorEvent$Connectivity;->cellular:Lcom/datadog/android/rum/model/ErrorEvent$Cellular;
