...
.method public constructor <init>(Ljava/io/File;Lcom/datadog/android/core/internal/privacy/ConsentProvider;Ljava/util/concurrent/ExecutorService;Lcom/datadog/android/core/internal/persistence/file/FileWriter;Lcom/datadog/android/core/internal/persistence/file/FileMover;Lcom/datadog/android/api/InternalLogger;Lcom/datadog/android/core/internal/persistence/file/FilePersistenceConfig;)V
    ...
    .param p1    # Ljava/io/File;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/datadog/android/core/internal/privacy/ConsentProvider;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p3    # Ljava/util/concurrent/ExecutorService;
        ...
        .end annotation
    .end param
    .param p4    # Lcom/datadog/android/core/internal/persistence/file/FileWriter;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    .param p6    # Lcom/datadog/android/api/InternalLogger;
        ...
        .end annotation
    .end param
    .param p7    # Lcom/datadog/android/core/internal/persistence/file/FilePersistenceConfig;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    .line 1
    .line 2
    new-instance v7, Lcom/datadog/android/core/internal/persistence/file/advanced/ConsentAwareFileOrchestrator;

    .line 3
    .line 4
    new-instance v2, Lcom/datadog/android/core/internal/persistence/file/single/SingleFileOrchestrator;
    ...
    .line 8
    .line 9
    invoke-virtual {v0, p1}, Lcom/datadog/android/ndk/internal/DatadogNdkCrashHandler$Companion;->getPendingNetworkInfoFile$dd_sdk_android_core_release(Ljava/io/File;)Ljava/io/File;
    ...
    .line 12
    .line 13
    invoke-direct {v2, v1, p6}, Lcom/datadog/android/core/internal/persistence/file/single/SingleFileOrchestrator;-><init>(Ljava/io/File;Lcom/datadog/android/api/InternalLogger;)V
    ...
    .line 17
    .line 18
    invoke-virtual {v0, p1}, Lcom/datadog/android/ndk/internal/DatadogNdkCrashHandler$Companion;->getGrantedNetworkInfoFile$dd_sdk_android_core_release(Ljava/io/File;)Ljava/io/File;
    ...
    .line 21
    .line 22
    invoke-direct {v3, p1, p6}, Lcom/datadog/android/core/internal/persistence/file/single/SingleFileOrchestrator;-><init>(Ljava/io/File;Lcom/datadog/android/api/InternalLogger;)V
    ...
    .line 26
    .line 27
    invoke-direct {v4, p5, p6}, Lcom/datadog/android/core/internal/persistence/file/advanced/ConsentAwareFileMigrator;-><init>(Lcom/datadog/android/core/internal/persistence/file/FileMover;Lcom/datadog/android/api/InternalLogger;)V
    ...
    .line 35
    .line 36
    new-instance v2, Lcom/datadog/android/core/internal/net/info/NetworkInfoSerializer;

    .line 37
    .line 38
    .line 39
    invoke-direct {v2}, Lcom/datadog/android/core/internal/net/info/NetworkInfoSerializer;-><init>()V
