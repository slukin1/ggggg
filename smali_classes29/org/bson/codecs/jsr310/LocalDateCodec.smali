...
.method public decode(Lorg/bson/BsonReader;Lorg/bson/codecs/DecoderContext;)Ljava/time/LocalDate;
    ...
    invoke-static {p1, p2}, Lcom/alibaba/fastjson2/p0;->a(Ljava/time/Instant;Ljava/time/ZoneId;)Ljava/time/ZonedDateTime;

    move-result-object p1

    invoke-static {p1}, Lcom/alibaba/fastjson2/q0;->a(Ljava/time/ZonedDateTime;)Ljava/time/LocalDate;
...
.method public encode(Lorg/bson/BsonWriter;Ljava/time/LocalDate;Lorg/bson/codecs/EncoderContext;)V
    ...
    invoke-static {p2, p3}, Lcom/alibaba/fastjson2/util/c0;->a(Ljava/time/LocalDate;Ljava/time/ZoneId;)Ljava/time/ZonedDateTime;
    ...
    invoke-static {p3}, Lcom/alibaba/fastjson2/reader/k;->a(Ljava/time/Instant;)J
    ...
    const-string/jumbo p2, "Unsupported LocalDate \'%s\' could not be converted to milliseconds: %s"
