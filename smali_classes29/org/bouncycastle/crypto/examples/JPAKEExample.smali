...
.method public static main([Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "Public parameters for the cyclic group:"
    ...
    const-string/jumbo v5, "g^{q} mod p = "
    ...
    const-string/jumbo v2, "************ Round 1 **************"

    invoke-virtual {v1, v2}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    sget-object v1, Ljava/lang/System;->out:Ljava/io/PrintStream;

    const-string/jumbo v2, "Alice sends to Bob: "
    ...
    const-string/jumbo v3, "Bob sends to Alice: "
    ...
    const-string/jumbo v1, "Alice checks g^{x4}!=1: OK"

    invoke-virtual {v0, v1}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    sget-object v0, Ljava/lang/System;->out:Ljava/io/PrintStream;

    const-string/jumbo v1, "Alice checks KP{x3}: OK"

    invoke-virtual {v0, v1}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    sget-object v0, Ljava/lang/System;->out:Ljava/io/PrintStream;

    const-string/jumbo v1, "Alice checks KP{x4}: OK"
    ...
    const-string/jumbo v0, "Bob checks g^{x2}!=1: OK"

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    sget-object p0, Ljava/lang/System;->out:Ljava/io/PrintStream;

    const-string/jumbo v0, "Bob checks KP{x1},: OK"

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    sget-object p0, Ljava/lang/System;->out:Ljava/io/PrintStream;

    const-string/jumbo v0, "Bob checks KP{x2},: OK"
    ...
    const-string/jumbo v10, "KP{x2*s}={"
    ...
    const-string/jumbo v13, "KP{x4*s}={"
    ...
    const-string/jumbo v1, "Alice checks KP{x4*s}: OK\n"
    ...
    const-string/jumbo v0, "Bob checks KP{x2*s}: OK\n"
    ...
    const-string/jumbo v2, "Alice checks MacTag: OK\n"
    ...
    const-string/jumbo v0, "Bob checks MacTag: OK\n"
    ...
    const-string/jumbo v0, "MacTags validated, therefore the keying material matches."
