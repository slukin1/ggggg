...
.method private doDigestFunction(Lorg/bouncycastle/est/ESTResponse;)Lorg/bouncycastle/est/ESTResponse;
    ...
    const-string/jumbo v3, "Unrecognised entry in WWW-Authenticate header: \'"
    ...
    const-string/jumbo v3, "Supplied realm \'"
    ...
    const-string/jumbo v3, "\' does not match server realm \'"
    ...
    const-string/jumbo v15, "auth-int"
    ...
    const-string/jumbo v3, "QoP value unknown: \'"
    ...
    const-string/jumbo v12, "00000001"
    ...
    const-string/jumbo v3, "auth digest algorithm unknown: "
    ...
    const-string/jumbo v2, "QoP value is empty."
    ...
    const-string/jumbo v2, "Qop is not defined in WWW-Authenticate header."
    ...
    const-string/jumbo v2, "WWW-Authenticate no algorithm defined."
    ...
    const-string/jumbo v6, "Parsing WWW-Authentication header: "
...
.method private getDigestCalculator(Ljava/lang/String;Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;)Lorg/bouncycastle/operator/DigestCalculator;
    ...
    .line 16
    .line 17
    const-string/jumbo v2, "cannot create digest calculator for "
