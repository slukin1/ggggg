...
.method public constructor <init>(Lorg/bouncycastle/asn1/cms/ContentInfo;Lorg/bouncycastle/operator/DigestCalculatorProvider;)V
    ...
    const-string/jumbo p2, "CMS Algorithm Identifier Protection check failed for macAlgorithm"
    ...
    const-string/jumbo p2, "CMS Algorithm Identifier Protection check failed for digestAlgorithm"
    ...
    const-string/jumbo p2, "A cmsAlgorithmProtect attribute MUST contain exactly one value"
    ...
    const-string/jumbo p2, "Only one instance of a cmsAlgorithmProtect attribute can be present"
