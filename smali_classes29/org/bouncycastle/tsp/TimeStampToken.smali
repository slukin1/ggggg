...
.method public constructor <init>(Lorg/bouncycastle/cms/CMSSignedData;)V
    ...
    const-string/jumbo v0, "no signing certificate attribute found, time stamp invalid."
    ...
    const-string/jumbo v2, "Time-stamp token signed by "
    ...
    const-string/jumbo p1, " signers, but it must contain just the TSA signature."
    ...
    const-string/jumbo v0, "ContentInfo object not for a time stamp."
...
.method private static getSignedData(Lorg/bouncycastle/asn1/cms/ContentInfo;)Lorg/bouncycastle/cms/CMSSignedData;
    ...
    .line 15
    .line 16
    const-string/jumbo v2, "TSP parsing error: "
...
.method public isSignatureValid(Lorg/bouncycastle/cms/SignerInformationVerifier;)Z
    ...
    .line 36
    .line 37
    const-string/jumbo v2, "CMS exception: "
...
.method public validate(Lorg/bouncycastle/cms/SignerInformationVerifier;)V
    ...
    .line 150
    .line 151
    const-string/jumbo v0, "certificate name does not match certID for signature. "
    ...
    .line 158
    .line 159
    const-string/jumbo v0, "certificate serial number does not match certID for signature."
    ...
    .line 190
    .line 191
    const-string/jumbo v0, "signature not created by certificate."
    ...
    .line 198
    .line 199
    const-string/jumbo v0, "certificate not valid when time stamp created."
    ...
    .line 206
    .line 207
    const-string/jumbo v0, "certificate hash does not match certID hash."
    ...
    .line 248
    .line 249
    const-string/jumbo v2, "problem processing certificate: "
