...
.method constructor <init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Z)V
    ...
    const-string/jumbo p2, "q must be prime"
    ...
    const-string/jumbo p2, "p must be prime"
    ...
    const-string/jumbo p2, "g^q mod p must equal 1"
    ...
    const-string/jumbo p2, "g must be in [2, p-1]"
    ...
    const-string/jumbo p2, "p-1 must be evenly divisible by q"
