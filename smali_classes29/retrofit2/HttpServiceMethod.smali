...
.method private static createCallAdapter(Lretrofit2/Retrofit;Ljava/lang/reflect/Method;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lretrofit2/CallAdapter;
    ...
    .line 13
    .line 14
    const-string/jumbo p2, "Unable to create call adapter for %s"
...
.method private static createResponseConverter(Lretrofit2/Retrofit;Ljava/lang/reflect/Method;Ljava/lang/reflect/Type;)Lretrofit2/Converter;
    ...
    .line 17
    .line 18
    const-string/jumbo p2, "Unable to create converter for %s"
...
.method static parseAnnotations(Lretrofit2/Retrofit;Ljava/lang/reflect/Method;Lretrofit2/RequestFactory;)Lretrofit2/HttpServiceMethod;
    ...
    .line 86
    .line 87
    const-string/jumbo p2, "Suspend functions should not return Call, as they already execute asynchronously.\nChange its return type to %s"
    ...
    .line 139
    :cond_3
    const-string/jumbo p0, "HEAD method must use Void or Unit as response type."
    ...
    .line 178
    :cond_7
    const-string/jumbo p0, "Response must include generic type (e.g., Response<String>)"
    ...
    .line 207
    .line 208
    const-string/jumbo p2, "\' is not a valid response body type. Did you mean ResponseBody?"
