...
.source "AuthorizationStrategyFactory.java"
...
# static fields
.field private static final TAG:Ljava/lang/String; = "AuthorizationStrategyFactory"

.field private static sInstance:Lcom/microsoft/identity/common/internal/ui/AuthorizationStrategyFactory;
...
.method private getBrowserAuthorizationStrategy(Landroid/content/Context;Landroid/app/Activity;Landroidx/fragment/app/Fragment;ZLjava/util/List;)Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationStrategy;
    .locals 1
    ...
    .line 11
    .line 12
    new-instance p4, Lcom/microsoft/identity/common/internal/ui/CurrentTaskBrowserAuthorizationStrategy;

    .line 13
    .line 14
    .line 15
    invoke-direct {p4, p1, p2, p3}, Lcom/microsoft/identity/common/internal/ui/CurrentTaskBrowserAuthorizationStrategy;-><init>(Landroid/content/Context;Landroid/app/Activity;Landroidx/fragment/app/Fragment;)V

    .line 16
    .line 17
    .line 18
    invoke-virtual {p4, p5}, Lcom/microsoft/identity/common/internal/ui/CurrentTaskBrowserAuthorizationStrategy;->setBrowserSafeList(Ljava/util/List;)V
    ...
    .line 23
    .line 24
    invoke-direct {v0, p1, p2, p3, p4}, Lcom/microsoft/identity/common/internal/ui/browser/BrowserAuthorizationStrategy;-><init>(Landroid/content/Context;Landroid/app/Activity;Landroidx/fragment/app/Fragment;Z)V

    .line 25
    .line 26
    .line 27
    invoke-virtual {v0, p5}, Lcom/microsoft/identity/common/internal/ui/browser/BrowserAuthorizationStrategy;->setBrowserSafeList(Ljava/util/List;)V
...
.method private getGenericAuthorizationStrategy(Lcom/microsoft/identity/common/internal/commands/parameters/InteractiveTokenCommandParameters;Landroid/content/Context;)Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationStrategy;
    .locals 2
    ...
    .line 8
    .line 9
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/commands/parameters/InteractiveTokenCommandParameters;->getFragment()Landroidx/fragment/app/Fragment;
    ...
    .line 12
    .line 13
    invoke-direct {v0, p2, v1, p1}, Lcom/microsoft/identity/common/internal/ui/webview/EmbeddedWebViewAuthorizationStrategy;-><init>(Landroid/content/Context;Landroid/app/Activity;Landroidx/fragment/app/Fragment;)V
...
.method private validAuthorizationAgent(Lcom/microsoft/identity/common/internal/ui/AuthorizationAgent;Landroid/content/Context;)Lcom/microsoft/identity/common/internal/ui/AuthorizationAgent;
    ...
    .line 17
    .line 18
    const-string/jumbo p2, "Unable to use browser to do the authorization because No available browser installed on the device. Use embedded webView instead."
...
# virtual methods
.method public getAuthorizationStrategy(Lcom/microsoft/identity/common/internal/commands/parameters/InteractiveTokenCommandParameters;)Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationStrategy;
    .locals 6
    .param p1    # Lcom/microsoft/identity/common/internal/commands/parameters/InteractiveTokenCommandParameters;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 6
    .line 7
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/commands/parameters/InteractiveTokenCommandParameters;->getAuthorizationAgent()Lcom/microsoft/identity/common/internal/ui/AuthorizationAgent;
    ...
    .line 13
    .line 14
    instance-of v4, p1, Lcom/microsoft/identity/common/internal/commands/parameters/BrokerInteractiveTokenCommandParameters;
    ...
    .line 21
    .line 22
    const-string/jumbo v2, "Use webView for authorization."
    ...
    .line 27
    .line 28
    invoke-direct {p0, p1, v1}, Lcom/microsoft/identity/common/internal/ui/AuthorizationStrategyFactory;->getGenericAuthorizationStrategy(Lcom/microsoft/identity/common/internal/commands/parameters/InteractiveTokenCommandParameters;Landroid/content/Context;)Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationStrategy;
    ...
    .line 33
    .line 34
    const-string/jumbo v3, "Use browser for authorization."
    ...
    .line 39
    :try_start_0
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/commands/parameters/InteractiveTokenCommandParameters;->getBrowserSafeList()Ljava/util/List;
    ...
    .line 42
    .line 43
    invoke-static {v1, v0}, Lcom/microsoft/identity/common/internal/ui/browser/BrowserSelector;->select(Landroid/content/Context;Ljava/util/List;)Lcom/microsoft/identity/common/internal/ui/browser/Browser;
    :try_end_0
    ...
    .line 48
    .line 49
    const-string/jumbo v5, "No supported browser available found. Fallback to the webView authorization agent."
    ...
    .line 53
    .line 54
    const-string/jumbo v2, "No available browser installed on the device."
    ...
    .line 89
    .line 90
    invoke-direct/range {v0 .. v5}, Lcom/microsoft/identity/common/internal/ui/AuthorizationStrategyFactory;->getBrowserAuthorizationStrategy(Landroid/content/Context;Landroid/app/Activity;Landroidx/fragment/app/Fragment;ZLjava/util/List;)Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationStrategy;
