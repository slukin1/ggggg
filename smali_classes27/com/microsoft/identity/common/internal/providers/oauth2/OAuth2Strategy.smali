...
# instance fields
.field protected final httpClient:Lcom/microsoft/identity/common/internal/net/HttpClient;

.field protected mAuthorizationEndpoint:Ljava/lang/String;

.field protected final mClockSkewManager:Lcom/microsoft/identity/common/internal/util/IClockSkewManager;

.field protected final mConfig:Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Configuration;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private mIssuer:Landroid/net/Uri;

.field protected final mStrategyParameters:Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2StrategyParameters;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Configuration;Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2StrategyParameters;)V
    ...
    .line 8
    .line 9
    iput-object v0, p0, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->httpClient:Lcom/microsoft/identity/common/internal/net/HttpClient;
    ...
    .line 20
    .line 21
    new-instance p1, Lcom/microsoft/identity/common/internal/util/ClockSkewManager;
    ...
    .line 27
    .line 28
    invoke-direct {p1, p2}, Lcom/microsoft/identity/common/internal/util/ClockSkewManager;-><init>(Landroid/content/Context;)V

    .line 29
    .line 30
    iput-object p1, p0, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->mClockSkewManager:Lcom/microsoft/identity/common/internal/util/IClockSkewManager;
    ...
    .line 33
    :cond_0
    sget-object p1, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->TAG:Ljava/lang/String;

    .line 34
    .line 35
    const-string/jumbo p2, "No valid context to persist clock skew with!"
...
.method private recordClockSkew(J)V
    ...
    .line 1
    .line 2
    iget-object v0, p0, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->mClockSkewManager:Lcom/microsoft/identity/common/internal/util/IClockSkewManager;
    ...
    .line 6
    .line 7
    invoke-interface {v0, p1, p2}, Lcom/microsoft/identity/common/internal/util/IClockSkewManager;->onTimestampReceived(J)V
...
.method private validateTokenResponse(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResult;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 1
    invoke-virtual {p2}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResult;->getSuccessResponse()Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResponse;

    move-result-object p2

    .line 2
    invoke-virtual {p0, p1, p2}, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->validateTokenResponse(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResponse;)V
...
.method public getAuthorityFromTokenEndpoint()Ljava/lang/String;
    ...
    .line 9
    .line 10
    const-string/jumbo v1, "oauth2/v2.0/token"
...
.method public getDeviceCode(Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest;)Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationResult;
    .locals 5
    ...
    .line 43
    .line 44
    iget-object v2, p0, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->httpClient:Lcom/microsoft/identity/common/internal/net/HttpClient;
    ...
    .line 50
    .line 51
    invoke-virtual {v3}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Configuration;->getDeviceAuthorizationEndpoint()Ljava/net/URL;
    ...
    .line 60
    .line 61
    invoke-interface {v2, v3, v1, v0}, Lcom/microsoft/identity/common/internal/net/HttpClient;->post(Ljava/net/URL;Ljava/util/Map;[B)Lcom/microsoft/identity/common/internal/net/HttpResponse;
    ...
    .line 69
    .line 70
    const-string/jumbo v3, ":getDeviceCode"
    ...
    .line 82
    .line 83
    new-instance v2, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy$1;

    .line 84
    .line 85
    .line 86
    invoke-direct {v2, p0}, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy$1;-><init>(Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;)V
    ...
    .line 97
    .line 98
    new-instance v1, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationResponse;
    ...
    .line 101
    .line 102
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationRequest;->getState()Ljava/lang/String;
    ...
    .line 105
    .line 106
    invoke-direct {v1, v2, p1, v0}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationResponse;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    .line 131
    .line 132
    const-string/jumbo v1, "Device Code Flow authorization successful..."
    ...
    .line 146
    .line 147
    new-instance v1, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy$2;

    .line 148
    .line 149
    .line 150
    invoke-direct {v1, p0}, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy$2;-><init>(Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;)V
    ...
    .line 180
    .line 181
    invoke-direct {v0, v1, p1}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationErrorResponse;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 206
    .line 207
    const-string/jumbo v1, "Device Code Flow authorization failure..."
...
.method protected getIssuer()Landroid/net/Uri;
    .locals 1
...
.method protected getOAuth2Configuration()Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Configuration;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TGenericOAuth2Configuration;"
...
.method protected getRequestBody(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;)Ljava/lang/String;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TGenericTokenRequest;)",
...
.method protected abstract getTokenResultFromHttpResponse(Lcom/microsoft/identity/common/internal/net/HttpResponse;)Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResult;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected performTokenRequest(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;)Lcom/microsoft/identity/common/internal/net/HttpResponse;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TGenericTokenRequest;)",
    ...
    .line 11
    .line 12
    const-string/jumbo v1, ":performTokenRequest"
    ...
    .line 20
    .line 21
    const-string/jumbo v1, "Performing token request..."
    ...
    .line 26
    .line 27
    invoke-virtual {p0, p1}, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->getRequestBody(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;)Ljava/lang/String;
    ...
    .line 54
    .line 55
    check-cast v3, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenRequest;

    .line 56
    .line 57
    .line 58
    invoke-virtual {v3}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenRequest;->getBrokerVersion()Ljava/lang/String;
    ...
    .line 67
    .line 68
    const-string/jumbo v4, "x-client-brkrver"
    ...
    .line 112
    .line 113
    invoke-virtual {v3}, Lcom/microsoft/identity/common/internal/eststelemetry/EstsTelemetry;->getTelemetryHeaders()Ljava/util/Map;
    ...
    .line 130
    .line 131
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenRequest;->getClientAppName()Ljava/lang/String;
    ...
    .line 143
    .line 144
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenRequest;->getClientAppVersion()Ljava/lang/String;
    ...
    .line 152
    .line 153
    invoke-virtual {p0}, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->getTokenEndpoint()Ljava/lang/String;
    ...
    .line 167
    .line 168
    invoke-interface {v2, p1, v1, v0}, Lcom/microsoft/identity/common/internal/net/HttpClient;->post(Ljava/net/URL;Ljava/util/Map;[B)Lcom/microsoft/identity/common/internal/net/HttpResponse;
    ...
    .line 171
    .line 172
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/net/HttpResponse;->getDate()Ljava/util/Date;
    ...
    .line 185
    .line 186
    invoke-direct {p0, v0, v1}, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->recordClockSkew(J)V
...
.method public requestToken(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;)Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResult;
    ...
    .line 20
    .line 21
    const-string/jumbo v1, "Requesting token..."
    ...
    .line 49
    .line 50
    invoke-virtual {v1, v2}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResponse;->setAuthority(Ljava/lang/String;)V
    ...
    .line 58
    .line 59
    invoke-direct {p0, p1, v0}, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->validateTokenResponse(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResult;)V
...
.method protected final setIssuer(Landroid/net/Uri;)V
    .locals 0
...
.method protected final setTokenEndpoint(Ljava/lang/String;)V
    ...
    .line 3
    .line 4
    iget-object p1, p0, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->mConfig:Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Configuration;
    ...
    .line 7
    .line 8
    instance-of v0, p1, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Configuration;
    ...
    .line 14
    .line 15
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/AzureActiveDirectoryOAuth2Configuration;->getSlice()Lcom/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/AzureActiveDirectorySlice;
    ...
    .line 30
    .line 31
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/AzureActiveDirectorySlice;->getSlice()Ljava/lang/String;
    ...
    .line 50
    :cond_0
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/AzureActiveDirectorySlice;->getDC()Ljava/lang/String;
...
.method protected abstract validateAuthorizationRequest(Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationRequest;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected abstract validateTokenRequest(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected abstract validateTokenResponse(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResponse;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
