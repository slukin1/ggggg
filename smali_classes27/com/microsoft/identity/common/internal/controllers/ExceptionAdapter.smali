...
.method public static applyCliTelemInfo(Lcom/microsoft/identity/common/internal/telemetry/CliTelemInfo;Lcom/microsoft/identity/common/exception/BaseException;)V
    .locals 1
    .param p0    # Lcom/microsoft/identity/common/internal/telemetry/CliTelemInfo;
...
.method public static baseExceptionFromException(Ljava/lang/Throwable;)Lcom/microsoft/identity/common/exception/BaseException;
    .locals 4
    ...
    .line 10
    :cond_0
    instance-of v0, p0, Lcom/microsoft/identity/common/exception/TerminalException;
    ...
    .line 14
    .line 15
    check-cast v0, Lcom/microsoft/identity/common/exception/TerminalException;

    .line 16
    .line 17
    .line 18
    invoke-virtual {v0}, Lcom/microsoft/identity/common/exception/TerminalException;->getErrorCode()Ljava/lang/String;
    ...
    .line 31
    .line 32
    const-string/jumbo v3, "An unhandled exception occurred with message: "
    ...
    .line 48
    .line 49
    invoke-direct {v1, v0, v2, p0}, Lcom/microsoft/identity/common/exception/ClientException;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 62
    .line 63
    const-string/jumbo v2, "An IO error occurred with message: "
    ...
    .line 78
    .line 79
    const-string/jumbo v2, "io_error"
...
.method public static exceptionFromAcquireTokenResult(Lcom/microsoft/identity/common/internal/result/AcquireTokenResult;Lcom/microsoft/identity/common/internal/commands/parameters/CommandParameters;)Lcom/microsoft/identity/common/exception/BaseException;
    .locals 3
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    .line 24
    .line 25
    invoke-virtual {v2}, Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationResult;->getAuthorizationStatus()Lcom/microsoft/identity/common/internal/providers/oauth2/AuthorizationStatus;
    ...
    .line 82
    .line 83
    new-instance p1, Lcom/microsoft/identity/common/exception/DeviceRegistrationRequiredException;
    ...
    .line 97
    .line 98
    invoke-direct {p1, v0, v1, p0}, Lcom/microsoft/identity/common/exception/DeviceRegistrationRequiredException;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 113
    .line 114
    invoke-direct {p0, p1, v0, v1, v2}, Lcom/microsoft/identity/common/exception/ServiceException;-><init>(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    .line 126
    .line 127
    const-string/jumbo v1, ":exceptionFromAcquireTokenResult"
    ...
    .line 135
    .line 136
    const-string/jumbo v1, "AuthorizationResult was null -- expected for ATS cases."
...
.method public static exceptionFromTokenResult(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResult;Lcom/microsoft/identity/common/internal/commands/parameters/CommandParameters;)Lcom/microsoft/identity/common/exception/ServiceException;
    .locals 2
    ...
    .line 34
    .line 35
    invoke-static {p1, v0}, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->getExceptionFromTokenErrorResponse(Lcom/microsoft/identity/common/internal/commands/parameters/CommandParameters;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)Lcom/microsoft/identity/common/exception/ServiceException;
    ...
    .line 42
    .line 43
    invoke-static {p0, p1}, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->applyCliTelemInfo(Lcom/microsoft/identity/common/internal/telemetry/CliTelemInfo;Lcom/microsoft/identity/common/exception/BaseException;)V
    ...
    .line 50
    .line 51
    sget-object v0, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->TAG:Ljava/lang/String;
    ...
    .line 55
    .line 56
    const-string/jumbo v0, ":exceptionFromTokenResult"
    ...
    .line 69
    .line 70
    const-string/jumbo v1, "Unknown error, Token result is null ["
    ...
    .line 94
    .line 95
    new-instance p1, Lcom/microsoft/identity/common/exception/ServiceException;

    .line 96
    .line 97
    const-string/jumbo p0, "Request failed, but no error returned back from service."
    ...
    .line 103
    .line 104
    invoke-direct {p1, v1, p0, v0}, Lcom/microsoft/identity/common/exception/ServiceException;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static getExceptionFromTokenErrorResponse(Lcom/microsoft/identity/common/internal/commands/parameters/CommandParameters;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)Lcom/microsoft/identity/common/exception/ServiceException;
    .locals 3
    .param p0    # Lcom/microsoft/identity/common/internal/commands/parameters/CommandParameters;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .param p1    # Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param

    .line 10
    invoke-static {p1}, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->isIntunePolicyRequiredError(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)Z
    ...
    .line 11
    invoke-static {p0}, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->isBrokerTokenCommandParameters(Lcom/microsoft/identity/common/internal/commands/parameters/CommandParameters;)Z
    ...
    .line 12
    :cond_0
    instance-of v0, p0, Lcom/microsoft/identity/common/internal/commands/parameters/BrokerInteractiveTokenCommandParameters;
    ...
    check-cast p0, Lcom/microsoft/identity/common/internal/commands/parameters/BrokerInteractiveTokenCommandParameters;

    invoke-direct {v0, v1, v2, p0}, Lcom/microsoft/identity/common/exception/IntuneAppProtectionPolicyRequiredException;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/microsoft/identity/common/internal/commands/parameters/BrokerInteractiveTokenCommandParameters;)V
    ...
    check-cast p0, Lcom/microsoft/identity/common/internal/commands/parameters/BrokerSilentTokenCommandParameters;

    invoke-direct {v0, v1, v2, p0}, Lcom/microsoft/identity/common/exception/IntuneAppProtectionPolicyRequiredException;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/microsoft/identity/common/internal/commands/parameters/BrokerSilentTokenCommandParameters;)V

    .line 19
    :goto_0
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;->getSubError()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Lcom/microsoft/identity/common/exception/ServiceException;->setOauthSubErrorCode(Ljava/lang/String;)V

    .line 20
    invoke-static {v0, p1}, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->setHttpResponseUsingTokenErrorResponse(Lcom/microsoft/identity/common/exception/ServiceException;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)V
    ...
    :cond_2
    :goto_1
    sget-object p0, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->TAG:Ljava/lang/String;

    const-string/jumbo v0, "In order to properly construct the IntuneAppProtectionPolicyRequiredException we need the command parameters to be supplied.  Returning as service exception instead."

    invoke-static {p0, v0}, Lcom/microsoft/identity/common/logging/Logger;->warn(Ljava/lang/String;Ljava/lang/String;)V

    .line 22
    invoke-static {p1}, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->getExceptionFromTokenErrorResponse(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)Lcom/microsoft/identity/common/exception/ServiceException;
...
.method public static getExceptionFromTokenErrorResponse(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)Lcom/microsoft/identity/common/exception/ServiceException;
    .locals 4
    .param p0    # Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 9
    invoke-static {v0, p0}, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->setHttpResponseUsingTokenErrorResponse(Lcom/microsoft/identity/common/exception/ServiceException;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)V

    return-object v0
.end method

.method private static isBrokerTokenCommandParameters(Lcom/microsoft/identity/common/internal/commands/parameters/CommandParameters;)Z
    .locals 1

    .line 1
    .line 2
    instance-of v0, p0, Lcom/microsoft/identity/common/internal/commands/parameters/BrokerSilentTokenCommandParameters;
    ...
    .line 5
    .line 6
    instance-of p0, p0, Lcom/microsoft/identity/common/internal/commands/parameters/BrokerInteractiveTokenCommandParameters;
...
.method private static isIntunePolicyRequiredError(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)Z
    .locals 2
    .param p0    # Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 38
    .line 39
    const-string/jumbo v0, "protection_policy_required"
...
.method private static setHttpResponseUsingTokenErrorResponse(Lcom/microsoft/identity/common/exception/ServiceException;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)V
    .locals 2
    .param p0    # Lcom/microsoft/identity/common/exception/ServiceException;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p1    # Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;
    ...
    .line 6
    .line 7
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;->getResponseHeadersJson()Ljava/lang/String;
    ...
    .line 10
    .line 11
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;->getResponseBody()Ljava/lang/String;
    ...
    .line 14
    .line 15
    invoke-static {v0, v1, p1}, Lcom/microsoft/identity/common/internal/controllers/ExceptionAdapter;->synthesizeHttpResponse(ILjava/lang/String;Ljava/lang/String;)Lcom/microsoft/identity/common/internal/net/HttpResponse;
    ...
    .line 18
    .line 19
    invoke-virtual {p0, p1}, Lcom/microsoft/identity/common/exception/ServiceException;->setHttpResponse(Lcom/microsoft/identity/common/internal/net/HttpResponse;)V
    :try_end_0
    ...
    .line 23
    .line 24
    const-string/jumbo p1, "Failed to deserialize error data: status, headers, response body."
...
.method private static synthesizeHttpResponse(ILjava/lang/String;Ljava/lang/String;)Lcom/microsoft/identity/common/internal/net/HttpResponse;
    .locals 1
    ...
    .line 25
    .line 26
    const-string/jumbo p1, ":applyHttpErrorResponseData"
