...
.method public process(Lcom/nimbusds/jose/JOSEObject;Lcom/nimbusds/jose/proc/SecurityContext;)Lcom/nimbusds/jose/Payload;
    ...
    const-string/jumbo v1, "Unexpected JOSE object type: "
...
.method public process(Lcom/nimbusds/jose/JWEObject;Lcom/nimbusds/jose/proc/SecurityContext;)Lcom/nimbusds/jose/Payload;
    ...
    const-string/jumbo v0, "JWE object rejected: "
    ...
    const-string/jumbo p2, "JWE object rejected: No matching decrypter(s) found"
    ...
    const-string/jumbo p2, "JWE object rejected: Another algorithm expected, or no matching key(s) found"
    ...
    const-string/jumbo p2, "JWE object rejected: No JWE key selector is configured"
    ...
    const-string/jumbo p2, "JWE object rejected: No JWE header \"typ\" (type) verifier is configured"
...
.method public process(Lcom/nimbusds/jose/JWSObject;Lcom/nimbusds/jose/proc/SecurityContext;)Lcom/nimbusds/jose/Payload;
    ...
    const-string/jumbo p2, "JWS object rejected: Invalid signature"
    ...
    const-string/jumbo p2, "JWS object rejected: Another algorithm expected, or no matching key(s) found"
    ...
    const-string/jumbo p2, "JWS object rejected: No JWS key selector is configured"
    ...
    const-string/jumbo p2, "JWS object rejected: No JWS header \"typ\" (type) verifier is configured"
...
.method public process(Lcom/nimbusds/jose/PlainObject;Lcom/nimbusds/jose/proc/SecurityContext;)Lcom/nimbusds/jose/Payload;
    ...
    const-string/jumbo p2, "Unsecured (plain) JOSE object rejected: No JWS header \"typ\" (type) verifier is configured"
    ...
    const-string/jumbo p2, "Unsecured (plain) JOSE objects are rejected, extend class to handle"
