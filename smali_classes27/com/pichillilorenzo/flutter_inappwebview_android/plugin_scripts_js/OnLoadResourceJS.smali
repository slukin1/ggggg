...
.method public static FLAG_VARIABLE_FOR_ON_LOAD_RESOURCE_JS_SOURCE()Ljava/lang/String;
    .locals 2
    ...
    .line 13
    .line 14
    const-string/jumbo v1, "._useOnLoadResource"
...
.method public static ON_LOAD_RESOURCE_JS_PLUGIN_SCRIPT(Ljava/util/Set;Z)Lcom/pichillilorenzo/flutter_inappwebview_android/types/PluginScript;
    .locals 9
    ...
    .line 4
    .line 5
    invoke-static {}, Lcom/pichillilorenzo/flutter_inappwebview_android/plugin_scripts_js/OnLoadResourceJS;->ON_LOAD_RESOURCE_JS_SOURCE()Ljava/lang/String;
    ...
    .line 9
    .line 10
    const-string/jumbo v1, "IN_APP_WEBVIEW_ON_LOAD_RESOURCE_JS_PLUGIN_SCRIPT"
...
.method public static ON_LOAD_RESOURCE_JS_SOURCE()Ljava/lang/String;
    .locals 2
    ...
    .line 19
    .line 20
    const-string/jumbo v1, " = true;(function() {   var observer = new PerformanceObserver(function(list) {       list.getEntries().forEach(function(entry) {         if ("
    ...
    .line 43
    .line 44
    const-string/jumbo v1, " == true) {           var resource = {             \'url\': entry.name,             \'initiatorType\': entry.initiatorType,             \'startTime\': entry.startTime,             \'duration\': entry.duration           };           window."
    ...
    .line 55
    .line 56
    const-string/jumbo v1, ".callHandler(\'onLoadResource\', resource);         }       });   });   observer.observe({entryTypes: [\'resource\']});})();"
