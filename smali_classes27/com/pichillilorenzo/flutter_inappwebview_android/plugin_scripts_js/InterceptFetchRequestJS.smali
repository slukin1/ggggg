...
.method public static FLAG_VARIABLE_FOR_SHOULD_INTERCEPT_FETCH_REQUEST_JS_SOURCE()Ljava/lang/String;
    .locals 2
    ...
    .line 13
    .line 14
    const-string/jumbo v1, "._useShouldInterceptFetchRequest"
...
.method public static INTERCEPT_FETCH_REQUEST_JS_PLUGIN_SCRIPT(Ljava/util/Set;Z)Lcom/pichillilorenzo/flutter_inappwebview_android/types/PluginScript;
    .locals 9
    ...
    .line 4
    .line 5
    invoke-static {}, Lcom/pichillilorenzo/flutter_inappwebview_android/plugin_scripts_js/InterceptFetchRequestJS;->INTERCEPT_FETCH_REQUEST_JS_SOURCE()Ljava/lang/String;
    ...
    .line 9
    .line 10
    const-string/jumbo v1, "IN_APP_WEBVIEW_INTERCEPT_FETCH_REQUEST_JS_PLUGIN_SCRIPT"
...
.method public static INTERCEPT_FETCH_REQUEST_JS_SOURCE()Ljava/lang/String;
    .locals 2
    ...
    .line 6
    .line 7
    const-string/jumbo v1, "(function(fetch) {  var w = (window.top == null || window.top === window) ? window : window.top;  w."
    ...
    .line 18
    .line 19
    const-string/jumbo v1, " = true;  if (fetch == null) {    return;  }  window.fetch = async function(resource, init) {    var w = (window.top == null || window.top === window) ? window : window.top;    if (w."
    ...
    .line 54
    .line 55
    const-string/jumbo v1, ".convertHeadersToJson(fetchRequest.headers);      }      fetchRequest.credentials = "
    ...
    .line 66
    .line 67
    const-string/jumbo v1, ".convertCredentialsToJson(fetchRequest.credentials);      return "
    ...
    .line 78
    .line 79
    const-string/jumbo v1, ".convertBodyRequest(fetchRequest.body).then(function(body) {        fetchRequest.body = body;        return window."
    ...
    .line 90
    .line 91
    const-string/jumbo v1, ".callHandler(\'shouldInterceptFetchRequest\', fetchRequest).then(function(result) {          if (result != null) {            switch (result.action) {              case 0:                var controller = new AbortController();                if (init != null) {                  init.signal = controller.signal;                } else {                  init = {                    signal: controller.signal                  };                }                controller.abort();                break;            }            if (result.body != null && !"
    ...
    .line 102
    .line 103
    const-string/jumbo v1, ".isString(result.body) && result.body.length > 0) {              var bodyString = "
    ...
    .line 114
    .line 115
    const-string/jumbo v1, ".arrayBufferToString(result.body);              if ("
    ...
    .line 126
    .line 127
    const-string/jumbo v1, ".isBodyFormData(bodyString)) {                var formDataContentType = "
    ...
    .line 138
    .line 139
    const-string/jumbo v1, ".getFormDataContentType(bodyString);                if (result.headers != null) {                  result.headers[\'Content-Type\'] = result.headers[\'Content-Type\'] == null ? formDataContentType : result.headers[\'Content-Type\'];                } else {                  result.headers = { \'Content-Type\': formDataContentType };                }              }            }            resource = result.url;            if (init == null) {              init = {};            }            if (result.method != null && result.method.length > 0) {              init.method = result.method;            }            if (result.headers != null && Object.keys(result.headers).length > 0) {              init.headers = "
    ...
    .line 150
    .line 151
    const-string/jumbo v1, ".convertJsonToHeaders(result.headers);            }            if ("
    ...
    .line 162
    .line 163
    const-string/jumbo v1, ".isString(result.body) || result.body == null) {              init.body = result.body;            } else if (result.body.length > 0) {              init.body = new Uint8Array(result.body);            }            if (result.mode != null && result.mode.length > 0) {              init.mode = result.mode;            }            if (result.credentials != null) {              init.credentials = "
