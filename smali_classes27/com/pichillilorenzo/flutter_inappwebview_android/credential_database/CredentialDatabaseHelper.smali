...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 3
    .line 4
    const-string/jumbo v2, "CredentialDatabase.db"
...
.method public clearAllTables(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "DROP TABLE IF EXISTS protection_space"
    ...
    .line 6
    .line 7
    const-string/jumbo v0, "DROP TABLE IF EXISTS credential"
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    .line 2
    const-string/jumbo v0, "CREATE TABLE protection_space (_id INTEGER PRIMARY KEY,host TEXT NOT NULL,protocol TEXT,realm TEXT,port INTEGER,UNIQUE(host, protocol, realm, port));"
    ...
    .line 6
    .line 7
    const-string/jumbo v0, "CREATE TABLE credential (_id INTEGER PRIMARY KEY,username TEXT NOT NULL,password TEXT NOT NULL,protection_space_id INTEGER NOT NULL,UNIQUE(username, password, protection_space_id),FOREIGN KEY (protection_space_id) REFERENCES protection_space (_id) ON DELETE CASCADE);"
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 1
    .line 2
    const-string/jumbo p2, "DROP TABLE IF EXISTS protection_space"
    ...
    .line 6
    .line 7
    const-string/jumbo p2, "DROP TABLE IF EXISTS credential"
