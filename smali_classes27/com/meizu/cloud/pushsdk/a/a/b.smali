...
.method private a(Ljava/net/URLConnection;)V
    ...
    const-string/jumbo v2, "get x_s_key = "
...
.method private b(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)Lcom/meizu/cloud/pushsdk/a/a/c;
    ...
    const-string/jumbo v2, "https://norma-external-collect.meizu.com/push/android/external/add.do"
    ...
    invoke-virtual {p3, p1}, Ljava/net/URLConnection;->setDoInput(Z)V

    invoke-virtual {p3, p1}, Ljava/net/URLConnection;->setDoOutput(Z)V

    const/4 p1, 0x0

    invoke-virtual {p3, p1}, Ljava/net/URLConnection;->setUseCaches(Z)V

    const/16 p1, 0x7530

    invoke-virtual {p3, p1}, Ljava/net/URLConnection;->setConnectTimeout(I)V

    invoke-virtual {p3, p1}, Ljava/net/URLConnection;->setReadTimeout(I)V
    ...
    invoke-virtual {p3, v2, p2}, Ljava/net/URLConnection;->setRequestProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "realStringPartRequest error "
...
.method private b(Ljava/net/URLConnection;)V
    ...
    const-string/jumbo v2, "get keyTimeout = "
