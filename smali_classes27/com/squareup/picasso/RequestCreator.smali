...
.method public error(I)Lcom/squareup/picasso/RequestCreator;
    ...
    const-string/jumbo v0, "Error image already set."
    ...
    const-string/jumbo v0, "Error image resource invalid."
...
.method public error(Landroid/graphics/drawable/Drawable;)Lcom/squareup/picasso/RequestCreator;
    ...
    const-string/jumbo v0, "Error image may not be null."
...
.method public fetch(Lcom/squareup/picasso/Callback;)V
    ...
    const-string/jumbo v0, "Fit cannot be used with fetch."
...
.method public into(Landroid/widget/ImageView;Lcom/squareup/picasso/Callback;)V
    ...
    const-string/jumbo v2, "Fit cannot be used with resize."
...
.method public into(Landroid/widget/RemoteViews;IILandroid/app/Notification;Ljava/lang/String;Lcom/squareup/picasso/Callback;)V
    ...
    const-string/jumbo v2, "Cannot use placeholder or error drawables with remote views."
    ...
    const-string/jumbo v2, "Fit cannot be used with RemoteViews."
    ...
    const-string/jumbo v2, "Notification must not be null."
...
.method public into(Landroid/widget/RemoteViews;I[ILcom/squareup/picasso/Callback;)V
    ...
    const-string/jumbo v2, "Fit cannot be used with remote views."
    ...
    const-string/jumbo v2, "appWidgetIds must not be null."
...
.method public into(Lcom/squareup/picasso/Target;)V
    ...
    const-string/jumbo v0, "Fit cannot be used with a Target."
...
.method public placeholder(I)Lcom/squareup/picasso/RequestCreator;
    ...
    const-string/jumbo v0, "Already explicitly declared as no placeholder."
...
.method public tag(Ljava/lang/Object;)Lcom/squareup/picasso/RequestCreator;
    ...
    .line 12
    .line 13
    const-string/jumbo v0, "Tag already set."
    ...
    .line 20
    .line 21
    const-string/jumbo v0, "Tag invalid."
