...
.method addAdapter(ILandroidx/recyclerview/widget/RecyclerView$Adapter;)Z
    ...
    const-string/jumbo v1, "All sub adapters must have stable ids when stable id mode is ISOLATED_STABLE_IDS or SHARED_STABLE_IDS"
    ...
    const-string/jumbo v1, "Index must be between 0 and "
...
.method public getLocalAdapterPosition(Landroidx/recyclerview/widget/RecyclerView$Adapter;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)I
    ...
    .line 42
    .line 43
    const-string/jumbo v3, "Detected inconsistent adapter updates. The local position of the view holder maps to "
    ...
    .line 50
    .line 51
    const-string/jumbo p3, " which is out of bounds for the adapter with size "
    ...
    .line 58
    .line 59
    const-string/jumbo p3, ".Make sure to immediately call notify methods in your adapter when you change the backing dataviewHolder:"
