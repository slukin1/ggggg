...
.method private _navigation(Lcom/alibaba/android/arouter/facade/Postcard;ILcom/alibaba/android/arouter/facade/callback/NavigationCallback;)Ljava/lang/Object;
    ...
    .line 89
    .line 90
    const-string/jumbo v0, "Fetch fragment instance error, "
...
.method static afterInit()V
    ...
    .line 5
    .line 6
    const-string/jumbo v1, "/arouter/service/interceptor"
...
.method static attachBaseContext()V
    ...
    .line 51
    .line 52
    const-string/jumbo v2, "ARouter hook instrumentation failed! ["
...
.method static declared-synchronized destroy()V
    ...
    .line 20
    .line 21
    const-string/jumbo v3, "ARouter destroy success!"
    ...
    .line 30
    .line 31
    const-string/jumbo v3, "Destroy can be used in debug mode only!"
...
.method private extractGroup(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 33
    .line 34
    const-string/jumbo v0, "ARouter::Extract the default group failed! There\'s nothing between 2 \'/\'!"
    ...
    .line 47
    .line 48
    const-string/jumbo v2, "Failed to extract default group! "
    ...
    .line 72
    .line 73
    const-string/jumbo v0, "ARouter::Extract the default group failed, the path must be start with \'/\' and contain more than 2 \'/\'!"
...
.method protected static getInstance()Lcom/alibaba/android/arouter/launcher/_ARouter;
    ...
    .line 33
    .line 34
    const-string/jumbo v1, "ARouterCore::Init::Invoke init(context) first!"
...
.method protected static declared-synchronized init(Landroid/app/Application;)Z
    ...
    .line 15
    .line 16
    const-string/jumbo v2, "ARouter init success!"
...
.method static inject(Ljava/lang/Object;)V
    ...
    .line 5
    .line 6
    const-string/jumbo v1, "/arouter/service/autowired"
...
.method static declared-synchronized monitorMode()V
    ...
    .line 11
    .line 12
    const-string/jumbo v3, "ARouter monitorMode on"
...
.method static declared-synchronized openDebug()V
    ...
    .line 11
    .line 12
    const-string/jumbo v3, "ARouter openDebug"
...
.method static declared-synchronized openLog()V
    ...
    .line 14
    .line 15
    const-string/jumbo v3, "ARouter openLog"
...
.method static declared-synchronized printStackTrace()V
    ...
    .line 14
    .line 15
    const-string/jumbo v3, "ARouter printStackTrace"
...
.method private startActivity(ILandroid/content/Context;Landroid/content/Intent;Lcom/alibaba/android/arouter/facade/Postcard;Lcom/alibaba/android/arouter/facade/callback/NavigationCallback;)V
    ...
    .line 22
    .line 23
    const-string/jumbo v0, "Must use [navigation(activity, ...)] to support [startActivityForResult]"
...
.method addRouteGroup(Lcom/alibaba/android/arouter/facade/template/IRouteGroup;)Z
    ...
    .line 19
    .line 20
    const-string/jumbo v5, "group loadInto from:"
    ...
    .line 31
    .line 32
    const-string/jumbo v5, ", with:_ARouter.addRouteGroup(group:"
    ...
    .line 60
    .line 61
    invoke-interface {v3, v0, v4}, Lcom/alibaba/android/arouter/facade/template/ILogger;->info(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 134
    .line 135
    const-string/jumbo v5, "Add route group ["
    ...
    .line 154
    .line 155
    const-string/jumbo v2, " new route meta."
    ...
    .line 171
    .line 172
    const-string/jumbo v3, "Add route group dynamic exception!"
...
.method protected build(Landroid/net/Uri;)Lcom/alibaba/android/arouter/facade/Postcard;
    ...
    const-string/jumbo v0, "ARouter::Parameter invalid!"
...
.method protected build(Ljava/lang/String;)Lcom/alibaba/android/arouter/facade/Postcard;
    ...
    const-string/jumbo v0, "ARouter::Parameter is invalid!"
...
.method protected build(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;)Lcom/alibaba/android/arouter/facade/Postcard;
    ...
    const-string/jumbo p2, "ARouter::Parameter is invalid!"
