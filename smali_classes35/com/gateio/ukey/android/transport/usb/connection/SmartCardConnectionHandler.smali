.class public Lcom/gateio/ukey/android/transport/usb/connection/SmartCardConnectionHandler;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/gateio/ukey/android/transport/usb/connection/UsbSmartCardConnection;",
        ">;"
    }
.end annotation
...
.method private findEndpoints(Landroid/hardware/usb/UsbInterface;)Landroid/util/Pair;
    ...
    .line 48
    .line 49
    const-string/jumbo v0, "Missing CCID bulk endpoints"
...
# virtual methods
.method public createConnection(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbDeviceConnection;)Lcom/gateio/ukey/android/transport/usb/connection/UsbSmartCardConnection;
    .locals 3
    ...
    .line 3
    invoke-direct {p0, p1}, Lcom/gateio/ukey/android/transport/usb/connection/SmartCardConnectionHandler;->findEndpoints(Landroid/hardware/usb/UsbInterface;)Landroid/util/Pair;

    move-result-object v0

    .line 4
    new-instance v1, Lcom/gateio/ukey/android/transport/usb/connection/UsbSmartCardConnection;
    ...
    invoke-direct {v1, p2, p1, v2, v0}, Lcom/gateio/ukey/android/transport/usb/connection/UsbSmartCardConnection;-><init>(Landroid/hardware/usb/UsbDeviceConnection;Landroid/hardware/usb/UsbInterface;Landroid/hardware/usb/UsbEndpoint;Landroid/hardware/usb/UsbEndpoint;)V
...
.method public bridge synthetic createConnection(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbDeviceConnection;)Lcom/gateio/ukey/core/YubiKeyConnection;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/gateio/ukey/android/transport/usb/connection/SmartCardConnectionHandler;->createConnection(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbDeviceConnection;)Lcom/gateio/ukey/android/transport/usb/connection/UsbSmartCardConnection;
